...
namespace Server.Network
{
	...
	public class EquipmentInfo
	{
        ...
        private int number;
        private bool v;
        private EquipInfoAttribute[] equipInfoAttributes;
        ...
        public EquipmentInfo(int number, bool v, EquipInfoAttribute[] equipInfoAttributes)
        {
            this.number = number;
            this.v = v;
            this.equipInfoAttributes = equipInfoAttributes;
        }
    }
