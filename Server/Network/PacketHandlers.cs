...
namespace Server.Network
{
    ...
    public static class PacketHandlers
    {
        ...
        static PacketHandlers()
        {
            ...
            Register(0x80, 356, false, AccountLogin);
            Register(0x83, 39, false, DeleteCharacter);
            Register(0x91, 359, false, GameLogin);
            ...
            Register(0xEF, 25, false, LoginServerSeed);
        ...
        public static void GameLogin(NetState state, PacketReader pvSrc)
        {
            ...
            string username = pvSrc.ReadString(320);
        ...
        public static void LoginServerSeed(NetState state, PacketReader pvSrc)
        {
            ...
            var sign = pvSrc.ReadUInt32();

            if (state.Seed == 0 || sign != 0xEA15DEAD)
            {
                Utility.PushColor(ConsoleColor.Red);
                Console.WriteLine("Login: {0}: Invalid Client", state);
                Utility.PopColor();
