...
namespace Server
{
    ...
    public enum FeatureFlags
    {
        ...
        // set special rules that apply to all expansions
        Custom = NinthAge | Gothic | Rustic | Jungle | Shadowguard,

        #endregion

        ExpansionNone = Custom,
        ExpansionT2A = ExpansionNone | T2A,
    ...
    public enum CharacterListFlags
    {
        ...
        SA = 0x100000, // enables gargoyles
        ForceTooltips = 0x200000,
        DisableProfessions = 0x400000,

        // set special rules that apply to all expansions
        Custom = ContextMenus | ForceTooltips | DisableProfessions,

        #endregion

        ExpansionNone = Custom,
        ExpansionT2A = ExpansionNone,
        ExpansionUOR = ExpansionT2A,
        ExpansionUOTD = ExpansionUOR,
        ExpansionLBR = ExpansionUOTD,
        ExpansionAOS = ExpansionLBR | AOS,
        ExpansionSE = ExpansionAOS | SE,
    ...
    public enum HousingFlags
    {
        ...
        // set special rules that apply to all expansions
        Custom = AOS | SE | ML | SA | HS | TOL | EJ | Crystal | Gothic | Rustic | Jungle | Shadowguard,

        #endregion

        HousingNone = Custom,
        HousingT2A = HousingNone,
        HousingUOR = HousingT2A,
        HousingUOTD = HousingUOR,
        HousingLBR = HousingUOTD,
        HousingAOS = HousingLBR | AOS,
