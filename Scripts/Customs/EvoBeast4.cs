...
namespace Server.Mobiles
{
    ...
    public class EvoBeast4 : BaseCreature
    {
        ...
        private List<int> EvoStageBodyValues = new List<int> { 737, 736, 28, 11, 173 };        

        [Constructable]
        public EvoBeast4() : base(AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            IsEvoPet = true;
            EvoStage = 0;
            EvoMaxStage = 4;
        ...
        public EvoBeast4(Serial serial) : base(serial)
        {
        }
