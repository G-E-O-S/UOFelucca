...
namespace Server.Mobiles
{
    ...
    public class EvoBeast3 : BaseCreature
    {
        ...
        private List<int> EvoStageBodyValues = new List<int> { 317, 60, 1420, 59, 197 };

        public override double HealChance { get { return 0.62; } }

        [Constructable]
        public EvoBeast3() : base(AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            IsEvoPet = true;
            EvoStage = 0;
            EvoMaxStage = 4;
        ...
        public EvoBeast3(Serial serial) : base(serial)
        {
        }
