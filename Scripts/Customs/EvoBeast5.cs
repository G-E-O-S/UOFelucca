...
namespace Server.Mobiles
{
    ...
    public class EvoBeast5 : BaseCreature
    {
        ...
        private List<int> EvoStageBodyValues = new List<int> { 21, 1289, 87, 249, 103 };

        [Constructable]
        public EvoBeast5() : base(AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            IsEvoPet = true;
            EvoStage = 0;
            EvoMaxStage = 4;
        ...
        public EvoBeast5(Serial serial) : base(serial)
        {
        }
