...
namespace Server.Mobiles
{
    ...
    public class EvoSteed1 : BaseMount
    {
        ...
        private List<int> EvoStageBodyValues = new List<int> { 0xE2, 132, 243, 0x114, 0x58E };

        // Since they are evos, we need to change the ItemID value as well
        private List<int> EvoStageItemValues = new List<int> { 0x3EA0, 0x3EAD, 0x3E94, 0x3E90, 0x58E };

        [Constructable]
        public EvoSteed1() : this("Felucca Steed")
        {
        }
        ...
        [Constructable]
        public EvoSteed1(string name) : base(name, 0xE2, 0x3EA0, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            IsEvoPet = true;
            EvoStage = 0;
            EvoMaxStage = 4;
        ...
        public EvoSteed1(Serial serial)
            : base(serial)
        {
        }
