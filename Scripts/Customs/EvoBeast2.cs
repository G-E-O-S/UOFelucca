...
namespace Server.Mobiles
{
    ...
    public class EvoBeast2 : BaseCreature
    {
        ...
        private List<int> EvoStageBodyValues = new List<int> { 17, 24, 75, 311, 281 };

        public override double HealChance { get { return 0.62; } }

        [Constructable]
        public EvoBeast2() : base(AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            IsEvoPet = true;
            EvoStage = 0;
            EvoMaxStage = 4;
        ...
        public EvoBeast2(Serial serial) : base(serial)
        {
        }
