...
{
	public class HolidayWoodenSign : Item, IFlipable
	{
		...
		{
			private readonly HolidayWoodenSign Sign;
			private readonly Mobile _From;

			public ChangeSignText(HolidayWoodenSign sign, Mobile from)
				: base(1158829)
			{
				Sign = sign;
				_From = from;
		...
		public HolidayWoodenSign(Serial serial)
			: base(serial)
		{
		}
