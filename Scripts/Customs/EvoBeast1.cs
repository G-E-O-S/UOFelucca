...
namespace Server.Mobiles
{
    ...
    public class EvoBeast1 : BaseCreature
    {
        ...
        private List<int> EvoStageBodyValues = new List<int> { 39, 306, 308, 9, 38 };

        public override double HealChance { get { return 0.62; } }

        [Constructable]
        public EvoBeast1() : base(AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            IsEvoPet = true;
            EvoStage = 0;
            EvoMaxStage = 4;
        ...
        public EvoBeast1(Serial serial) : base(serial)
        {
        }
