...
namespace Server.Items
{
    public class ShrinkItem : Item
    {
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string MobTypeString => m_MobTypeString;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int StatStr => m_PetStr;

        [CommandProperty(AccessLevel.GameMaster)]
        public int StatDex => m_PetDex;

        [CommandProperty(AccessLevel.GameMaster)]
        public int StatInt => m_PetInt;

        [CommandProperty(AccessLevel.GameMaster)]
        public int StatHits => m_PetHits;

        [CommandProperty(AccessLevel.GameMaster)]
        public int StatStam => m_PetStam;

        [CommandProperty(AccessLevel.GameMaster)]
        public int StatMana => m_PetMana;

        [CommandProperty(AccessLevel.GameMaster)]
        public int ResistPhysical => m_PetPhysicalResist;

        [CommandProperty(AccessLevel.GameMaster)]
        public int ResistCold => m_PetColdResist;

        [CommandProperty(AccessLevel.GameMaster)]
        public int ResistFire => m_PetFireResist;

        [CommandProperty(AccessLevel.GameMaster)]
        public int ResistPoison => m_PetPoisonResist;

        [CommandProperty(AccessLevel.GameMaster)]
        public int ResistEnergy => m_PetEnergyResist;

        [CommandProperty(AccessLevel.GameMaster)]
        public int DamageTypePhysical => m_PetPhysicalDamage;

        [CommandProperty(AccessLevel.GameMaster)]
        public int DamageTypeCold => m_PetColdDamage;

        [CommandProperty(AccessLevel.GameMaster)]
        public int DamageTypeFire => m_PetFireDamage;

        [CommandProperty(AccessLevel.GameMaster)]
        public int DamageTypePoison => m_PetPoisonDamage;

        [CommandProperty(AccessLevel.GameMaster)]
        public int DamageTypeEnergy => m_PetEnergyDamage;

        [CommandProperty(AccessLevel.GameMaster)]
        public double SkillWrestling => m_PetWrestling;

        [CommandProperty(AccessLevel.GameMaster)]
        public double SkillTactics => m_PetTactics;

        [CommandProperty(AccessLevel.GameMaster)]
        public double SkillMagicResist => m_PetResist;

        [CommandProperty(AccessLevel.GameMaster)]
        public double SkillAnatomy => m_PetAnatomy;

        [CommandProperty(AccessLevel.GameMaster)]
        public double SkillPoisoning => m_PetPoisoning;

        [CommandProperty(AccessLevel.GameMaster)]
        public double SkillMagery => m_PetMagery;

        [CommandProperty(AccessLevel.GameMaster)]
        public double SkillEvalInt => m_PetEvalInt;

        [CommandProperty(AccessLevel.GameMaster)]
        public double SkillMeditation => m_PetMed;

        [CommandProperty(AccessLevel.GameMaster)]
        public int PetMinDamage => m_PetMinDamage;

        [CommandProperty(AccessLevel.GameMaster)]
        public int PetMaxDamage => m_PetMaxDamage;
        ...
        //{
        //    if (!Deleted && m_Pet != null)
        //    {
        //        from.CloseGump(typeof(NewAnimalLoreGump));
        //        BaseGump.SendGump(new NewAnimalLoreGump((PlayerMobile)from, m_Pet));
        //    }
