...
namespace Server.Gumps
{
    public class PetStatGump : Gump
    {
        ...
        public PetStatGump(BaseCreature pet, Mobile from) : base(25, 25)
        {
            ...
            Resizable = false;
            AddPage(0);
            AddBackground(24, 25, 346, 289, 1755 /* 5120 */);

            AddLabel(33, 27, 1160, bc.Name.ToString());
            AddImageTiled(27, 47, 342, 2, 1756 /* 5121 */);
            ...
            AddImageTiled(27, 135, 342, 2, 1756 /* 5121 */);
            AddLabel(35, 145, 1149, @"Gender:");
            AddLabel(35, 165, 1149, @"Can Mate:");
            AddImageTiled(27, 185, 342, 2, 1756 /* 5121 */);
            AddImageTiled(27, 275, 342, 2, 1756 /* 5121 */);
    ...
    public class BeginMatingTarget : Target
    {
        ...
        protected override void OnTarget(Mobile from, object target)
        {
            ...
            else if (target is BaseCreature)
            {
                ...
                {
                    from.SendMessage("That creature has mating in that last two days, It cannot mate again so soon.");
                }
