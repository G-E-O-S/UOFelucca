...
namespace Server.Gumps
{
    ...
    {
        private readonly Mobile m_Pet1;
        private readonly Mobile m_Pet2;
        ...
        public BreedingAcceptGump(Mobile pet1, Mobile pet2) : base(0, 0)
        {
            ...
            Resizable = false;
            AddPage(0);
            AddBackground(25, 22, 318, 324, 1755 /* 9380 */);
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            if (info.ButtonID == 2)
            {
                ...
                else if( (Utility.Random(chance) - dLuck ) < 1500)
                {
                    ...
                    if (cm2 != null) //Generate Claim Ticket One
                    {
                        ...
                        breeder.SayTo(cm2, "I'll hold onto your pet for you while it's mating");
                        breeder.SayTo(cm2, "Return here in two days and the show me that claim ticket");
                    ...
                    {
                        bc1.MatingDelay = DateTime.UtcNow + TimeSpan.FromHours(48.0 /* 144.0 */);
                        bc2.MatingDelay = DateTime.UtcNow + TimeSpan.FromHours(48.0 /* 144.0 */);
                    }
                }
                else
                {
                    if (cm1 != null && cm2 != null)
                    {
                        ...
                        cm2.SendMessage("Breeding Failed: It is hard to successfully mate to strong pets together, You will have to wait one hourb to try again.");
                        bc1.MatingDelay = DateTime.UtcNow + TimeSpan.FromHours(1.0 /* 12.0 */);
                        bc2.MatingDelay = DateTime.UtcNow + TimeSpan.FromHours(1.0 /* 12.0 */);
                    }
                }
            }
