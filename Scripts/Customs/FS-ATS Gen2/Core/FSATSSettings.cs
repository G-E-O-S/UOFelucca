namespace Server
{
    ...
    public class FSATS
    {
		...
		***********************************************/
        ...
        public static readonly int NormalSTAM = 1000;
        ...
        public static readonly int NormalPhys = 85;

        //Normal Creatures PhysFire Cap
        public static readonly int NormalFire = 85;

        //Normal Creatures PhysCold Cap
        public static readonly int NormalCold = 85;

        //Normal Creatures PhysEnergy Cap
        public static readonly int NormalEnergy = 85;

        //Normal Creatures PhysPoison Cap
        public static readonly int NormalPoison = 85;

        //Normal Creatures V Armor Cap
        public static readonly int NormalVArmor = 50;
		...
		***********************************************/
        ...
        public static readonly int BioPoison = 100;
