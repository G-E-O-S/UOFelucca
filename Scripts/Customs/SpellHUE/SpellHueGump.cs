...
{
    public class SpellHueGump : Gump
    {
        private SpellHueDeed m_Deed;

        private static List<int> m_HuesList = new List<int>()
        {
            1196, 1109, 2732, 1964, 2723, 38,  1281,
            1916, 1174, 1153, 1317, 1967, 2075,  1910,
            1152, 2741, 2671, 2720, 1914, 1272,
        };

        public SpellHueGump(SpellHueDeed deed)
            : base(0, 0)
        {
            m_Deed = deed;
            ...
            {
                if (i > 0 && i % 7 == 0) // new line of spells each 7 draws
                {
