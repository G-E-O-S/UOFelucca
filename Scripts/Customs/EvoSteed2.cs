...
namespace Server.Mobiles
{
    ...
    public class EvoSteed2 : BaseMount
    {
        ...
        private List<int> EvoStageBodyValues = new List<int> { 0xDC, 0x319, 0x31A, 0x11C, 0x42D };

        // Since they are evos, we need to change the ItemID value as well
        private List<int> EvoStageItemValues = new List<int> { 0xDC, 0x319, 0x31A, 0x11C, 0x42D };

        [Constructable]
        public EvoSteed2() : this("Felucca Steed")
        {
        }
        ...
        [Constructable]
        public EvoSteed2(string name) : base(name, 0xDC, 0x3EA6, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            IsEvoPet = true;
            EvoStage = 0;
            EvoMaxStage = 4;
        ...
        public EvoSteed2(Serial serial)
            : base(serial)
        {
        }
