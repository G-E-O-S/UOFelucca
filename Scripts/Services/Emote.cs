...
namespace Server.Commands
{
    ...
    public class Emote
    {
        ...
        private static Dictionary<Mobile, DateTime> LastEmoteTime = new Dictionary<Mobile, DateTime>();
        ...
        private static void Emote_OnCommand(CommandEventArgs e)
        {
            ...
            if (LastEmoteTime.ContainsKey(pm) && DateTime.UtcNow - LastEmoteTime[pm] < TimeSpan.FromSeconds(5))
            {
                pm.SendMessage("You must wait 5 seconds before using another emote.");
                return;
            }
            ...
            if (SoundInt > 0)
            {
                ...
                // Update the last emote usage time for the player
                LastEmoteTime[pm] = DateTime.UtcNow;
            }
        }
    }
                ...
                case EmotePage.P4:
                    {
                        ...
                        AddButtonLabeled(10, 240, GetButtonID(1, 43), "Ta-Dah");
    ...
    public class ItemRemovalTimer : Timer
    {
        ...
        public ItemRemovalTimer(Item item) : base(TimeSpan.FromSeconds(0.0001)) // changed from 1.00
