...
namespace Server.Engines.BulkOrders
{
    ...
    public class BulkOrderSystem
    {
        ...
        public static readonly int MaxCachedDeeds = 2; // default 2
        public static readonly int Delay = 1; // default 6

        public static bool NewSystemEnabled = Core.TOL; // default TOL
        ...
        public static TimeSpan GetNextBulkOrder(BODType type, PlayerMobile pm)
        {
            ...
            if (context != null)
            {
                ...
                else if (context.Entries.ContainsKey(type))
                {
                    ...
                    return TimeSpan.Zero; // default DateTime.UtcNow - dt
                }                
            }
