...
namespace Server.Mobiles
{
    public abstract class AreaEffect
    {
        ...
        public virtual int MaxRange { get { return 2; } } // default 3
        public virtual double TriggerChance { get { return 0.5; } } // default 1.0
        public virtual TimeSpan CooldownDuration { get { return TimeSpan.FromSeconds(60); } } // default 30
        public virtual bool RequiresCombatant { get { return true; } }

        public virtual int EffectRange { get { return 3; } } // default 5
    ...
    public class AuraDamage : AreaEffect
    {
        ...
        public class AuraDefinition
        {
            ...
            public static void Initialize()
            {
                ...
                coldAura.Damage = 2; // default 15
                coldAura.Fire = 0;
                coldAura.Cold = 100; // default 100
