...
namespace Server.Mobiles
{
    ...
    {
        public override int MaxRange { get { return 6; } } // default 12
        ...
        {
            int damage = (int)(creature.RawStr * def.DamageScalar); // default - int damage = (int)(creature.Hits * def.DamageScalar);
            ...
            if (damage > 65) // default 200
            {
                damage = 65; // default 200
            }
        ...
        public class DragonBreathDefinition
        {
            ...
            public static void Initialize()
            {
                Definitions.Add(new DragonBreathDefinition(
                    ...
                    1.3,
                    1.0,
                    0, 100, 0, 0, 0, 0, 0, // default 0, 100, 0, 0, 0, 0, 0,
                    30.0, 45.0,
                    0x36D4,
                    5,
                    0,
