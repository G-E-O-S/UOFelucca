...
namespace Server.Engines.CannedEvil
{
	public class ChampionSystem
	{
		...
		public static void Configure()
		{
			...
			m_GoldShowerPiles = Config.Get("Champions.GoldPiles", 50); // default 50
			m_GoldShowerMinAmount = Config.Get("Champions.GoldMin", 999); // default 4000
			m_GoldShowerMaxAmount = Config.Get("Champions.GoldMax", 4999); // default 5500
			m_HarrowerGoldPiles = Config.Get("Champions.HarrowerGoldPiles", 75); // default 75
			m_HarrowerGoldMinAmount = Config.Get("Champions.HarrowerGoldMin", 999); // default 5000
			m_HarrowerGoldMaxAmount = Config.Get("Champions.HarrowerGoldMax", 4999); // default 10000
			m_PowerScrollAmount = Config.Get("Champions.PowerScrolls", 6);
			m_StatScrollAmount = Config.Get("Champions.StatScrolls", 0); // default 16
			m_ScrollChance = Config.Get("Champions.ScrollChance", 0.1d) / 100.0d; // defualt 0.1d) / 100.0d;
			m_TranscendenceChance = Config.Get("Champions.TranscendenceChance", 50.0d) / 100.0d; // default 50.0d) / 100.0d;
			...
			m_MaxKill[0] = Config.Get("Champions.Rank1MaxKills", 64); // default 128
			m_MaxKill[1] = Config.Get("Champions.Rank2MaxKills", 32); // default 64
			m_MaxKill[2] = Config.Get("Champions.Rank3MaxKills", 16); // default 32
			m_MaxKill[3] = Config.Get("Champions.Rank4MaxKills", 12); // default 18
