...
namespace Server.Mobiles
{
    public class Paragon
    {
        ...
        public static double ChocolateIngredientChance = .01;// Chance that a paragon will drop a chocolatiering ingredient
        ...
        public static int Hue = 2721;// Paragon hue

        // Buffs
        public static double HitsBuff = 3.0;
        public static double StrBuff = 0.80;
        public static double IntBuff = 0.80;
        public static double DexBuff = 0.80;
        public static double SkillsBuff = 0.80;
        public static double SpeedBuff = 0.80;
