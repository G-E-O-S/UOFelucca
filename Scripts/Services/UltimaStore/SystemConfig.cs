...
namespace Server.Engines.UOStore
{
    ...
    public static class Configuration
    {
        ...
        static Configuration()
        {
            ...
            Expansion = Config.GetEnum("Store.Expansion", Expansion.LBR); // default TOL
            Website = Config.Get("Store.Website", "https://uofelucca.com");
        ...
        public static int GetCustomCurrency(Mobile m)
        {
            ...
            m.SendMessage(33, "Please contact Queen to donate!");
