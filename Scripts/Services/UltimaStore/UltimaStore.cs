...
namespace Server.Engines.UOStore
{
    ...
    public static class UltimaStore
    {
        ...
        public static void OpenStore(PlayerMobile user)
        {
            ...
            //user.SendMessage("<A HREF=\"https://paypal.me/ilookafterdogs?country.x=GB&locale.x=en_GB\">Visit our website</A>.");

            user.LaunchBrowser("https://paypal.me/UOFelucca?country.x=GB&locale.x=en_GB");
