...
namespace Server.Engines.Craft
{
    ...
    public class CraftItem
    {
		...
		private static readonly Type[][] ItemTypesTable =
        {
            ...
            new[] {typeof(Cloth), typeof(UncutCloth), typeof(AbyssalCloth), typeof(BlightedGroveCloth), typeof(BloodCloth), typeof(CovetousCloth), typeof(DaemonicTempleCloth),
                typeof(DeceitCloth), typeof(DespiseCloth), typeof(WindCloth), typeof(DestardCloth), typeof(EvilCloth), typeof(FireCloth), typeof(HythlothCloth), typeof(IceCloth),
                typeof(JurassicParkCloth), typeof(KhaldunCloth), typeof(MysticCloth), typeof(OceanCloth), typeof(OrcCaveCloth), typeof(PaintedCavesCloth), typeof(PalaceOfParoxysmusCloth),
                typeof(ParagonCloth), typeof(PrismOfLightCloth), typeof(SanctuaryCloth), typeof(SerpentsHoldCloth), typeof(ShadowCloth), typeof(ShameCloth), typeof(SolenHivesCloth),
                typeof(SunburstCloth), typeof(TaintedCloth), typeof(TerathanKeepCloth), typeof(TerrorCloth), typeof(TrinsicCloth), typeof(WrongCloth), typeof(FallonCloth),
                typeof(PureWhiteCloth)},            
		...
		private static readonly Type[] m_ColoredResourceTable =
		{
			...
			typeof(PlantPigment), typeof(BlightedGroveCloth), typeof(BloodCloth), typeof(CovetousCloth), typeof(DaemonicTempleCloth), typeof(DeceitCloth), typeof(DespiseCloth),
            typeof(WindCloth), typeof(DestardCloth), typeof(EvilCloth), typeof(FireCloth), typeof(HythlothCloth), typeof(IceCloth), typeof(JurassicParkCloth), typeof(KhaldunCloth),
            typeof(MysticCloth), typeof(OceanCloth), typeof(OrcCaveCloth), typeof(PaintedCavesCloth), typeof(PalaceOfParoxysmusCloth), typeof(ParagonCloth), typeof(PrismOfLightCloth),
            typeof(SanctuaryCloth), typeof(SerpentsHoldCloth), typeof(ShadowCloth), typeof(ShameCloth), typeof(SolenHivesCloth), typeof(SunburstCloth), typeof(TaintedCloth),
            typeof(TerathanKeepCloth), typeof(TerrorCloth), typeof(TrinsicCloth), typeof(WrongCloth), typeof(BaseContainer), typeof(FallonCloth), typeof(PureWhiteCloth)
        };
