...
namespace Server.Engines.Craft
{
    ...
    public class DefTinkering : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(typeof(NewHitchingPostEastDeed), 1044051, 1071127, 90.0, 160.0, typeof(IronIngot), 1044036, 50, 1044253);
            index = AddCraft(typeof(NewHitchingPostSouthDeed), 1044051, 1071127, 90.0, 160.0, typeof(IronIngot), 1044036, 50, 1044253);
