...
namespace Server.Engines.VeteranRewards
{
    public class RewardChoiceGump : Gump
    {
        ...
        private void RenderCategories()
        {
            ...
            this.AddHtml(60, 35, 500, 70, "<B>UO Felucca Rewards Program</B><BR>" +
                                          "Thank you for being a part of the UO Felucca community, you may select from the following " +
                                          "in-game reward items listed below. The gift item(s) will be attributed to the character " +
                                          "that claims the reward! The number of rewards you are entitled to are listed below and " +
                                          "are for your entire account. To learn more about what UO Felucca has to offer please " +
                                          "visit the shards website at <A HREF=\"http://www.uofelucca.com\">http://www.uofelucca.com</A>.", true, true);                              
