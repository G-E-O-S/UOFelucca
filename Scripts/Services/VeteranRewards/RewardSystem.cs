...
namespace Server.Engines.VeteranRewards
{
    ...
    public class RewardSystem
    {
        ...
        public static void SetupRewardTables()
        {
            ...
            m_Lists = new RewardList[]
            {
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    ...
                    new RewardEntry(cloaksAndRobes, 1080366, typeof(RewardDress), Expansion.LBR, Bronze, 1080366),
                    ...
                    new RewardEntry(cloaksAndRobes, 1080367, typeof(RewardDress), Expansion.LBR, Copper, 1080367),
                    ...
                    new RewardEntry(monsterStatues, 1156367, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.DragonTurtle),
                    new RewardEntry(monsterStatues, 1158875, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.Krampus),
                    new RewardEntry(monsterStatues, 1159417, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.Pig),

                    new RewardEntry(etherealSteeds, 1006019, typeof(EtherealHorse)),

                    new RewardEntry(houseAddOns,    1062692, typeof(ContestMiniHouseDeed), Expansion.LBR, MiniHouseType.MalasMountainPass),
                    new RewardEntry(houseAddOns,    1072216, typeof(ContestMiniHouseDeed), Expansion.LBR, MiniHouseType.ChurchAtNight),                   

                    new RewardEntry(miscellaneous,  1076155, typeof(RedSoulstone),         Expansion.SA),
                    new RewardEntry(miscellaneous,  1080523, typeof(CommodityDeedBox),     Expansion.LBR),
                    ...
                    new RewardEntry(miscellaneous,    1123603,  typeof(CoralTheOwl), Expansion.LBR),
                    new RewardEntry(miscellaneous,    1151769,  typeof(GreaterBraceletOfBinding), Expansion.LBR),
                    new RewardEntry(miscellaneous,    1156371,  typeof(Auction.AuctionSafeDeed), Expansion.LBR),
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    ...
                    new RewardEntry(cloaksAndRobes, 1080369, typeof(RewardDress), Expansion.LBR, Agapite, 1080369),
                    ...
                    new RewardEntry(cloaksAndRobes, 1080368, typeof(RewardDress), Expansion.LBR, Golden, 1080368),

                    new RewardEntry(monsterStatues, 1155747, typeof(MonsterStatuette), MonsterStatuetteType.CrystalElemental),
                    new RewardEntry(monsterStatues, 1157078, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.TRex),
                    new RewardEntry(monsterStatues, 1158877, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.KhalAnkur),
                    new RewardEntry(monsterStatues, 1159418, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.Goat),

                    new RewardEntry(houseAddOns,    1006048, typeof(BannerDeed)),
                    new RewardEntry(houseAddOns,    1006049, typeof(FlamingHeadDeed)),
                    new RewardEntry(houseAddOns,    1080409, typeof(MinotaurStatueDeed), Expansion.LBR)
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    ...
                    new RewardEntry(cloaksAndRobes, 1080370, typeof(RewardDress), Expansion.LBR, Verite, 1080370),
                    ...
                    new RewardEntry(cloaksAndRobes, 1080371, typeof(RewardDress), Expansion.LBR, Valorite, 1080371),
                    ...
                    new RewardEntry(monsterStatues, 1157079, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.Zipactriotal),
                    new RewardEntry(monsterStatues, 1158876, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.KrampusMinion),
                    new RewardEntry(monsterStatues, 1159419, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.IceFiend),


                    new RewardEntry(etherealSteeds, 1006051, typeof(EtherealLlama)),
                    new RewardEntry(etherealSteeds, 1006050, typeof(EtherealOstard)),

                    new RewardEntry(houseAddOns,    1080407, typeof(PottedCactusDeed), Expansion.LBR)
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    ...
                    new RewardEntry(cloaksAndRobes, 1113886, typeof(RewardGargishFancyRobe), Expansion.LBR, DarkGray, 1113886),
                    new RewardEntry(cloaksAndRobes, 1113887, typeof(RewardGargishRobe), Expansion.LBR, DarkGray, 1113887),
                    new RewardEntry(cloaksAndRobes, 1080374, typeof(RewardDress), Expansion.LBR, DarkGray, 1080374),
                    ...
                    new RewardEntry(cloaksAndRobes, 1080372, typeof(RewardDress), Expansion.LBR, IceGreen, 1080372),
                    ...
                    new RewardEntry(cloaksAndRobes, 1080373, typeof(RewardDress), Expansion.LBR, IceBlue, 1080373),
                    ...
                    new RewardEntry(miscellaneous,  1158880, typeof(EmbroideryTool), Expansion.SA),
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    ...
                    new RewardEntry(cloaksAndRobes, 1080377, typeof(RewardDress), Expansion.LBR, JetBlack, 1080377),
                    ...
                    new RewardEntry(cloaksAndRobes, 1080376, typeof(RewardDress), Expansion.LBR, IceWhite, 1080376),
                    ...
                    new RewardEntry(cloaksAndRobes, 1080375, typeof(RewardDress), Expansion.LBR, Fire, 1080375),
                    ...
                    new RewardEntry(monsterStatues, 1157080, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.MyrmidexQueen),
                    ...
                    new RewardEntry(houseAddOns,    1080384, typeof(BloodyPentagramDeed), Expansion.LBR),
                    new RewardEntry(houseAddOns,    1154582, typeof(LighthouseAddonDeed), Expansion.LBR),
                    new RewardEntry(houseAddOns,    1158860, typeof(RepairBenchDeed), Expansion.LBR),
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    new RewardEntry(houseAddOns,    1076188, typeof(CharacterStatueMaker), Expansion.LBR, StatueType.Jade),
                    new RewardEntry(houseAddOns,    1076189, typeof(CharacterStatueMaker), Expansion.LBR, StatueType.Marble),
                    new RewardEntry(houseAddOns,    1076190, typeof(CharacterStatueMaker), Expansion.LBR, StatueType.Bronze),
                    new RewardEntry(houseAddOns,    1080527, typeof(RewardBrazierDeed), Expansion.LBR)
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    new RewardEntry(houseAddOns,    1076157, typeof(CannonDeed),           Expansion.LBR),
                    new RewardEntry(houseAddOns,    1080550, typeof(TreeStumpDeed),        Expansion.LBR),
                    new RewardEntry(houseAddOns,    1151835, typeof(SheepStatueDeed),      Expansion.LBR),
                    new RewardEntry(houseAddOns,    1123504, typeof(SewingMachineDeed),    Expansion.LBR),
                    new RewardEntry(houseAddOns,    1123577, typeof(SmithingPressDeed),    Expansion.LBR),
                    new RewardEntry(houseAddOns,    1156369, typeof(SpinningLatheDeed),    Expansion.LBR),
                    new RewardEntry(houseAddOns,    1156370, typeof(FletchingStationDeed), Expansion.LBR),
                    new RewardEntry(houseAddOns,    1157071, typeof(BBQSmokerDeed),        Expansion.LBR),
                    new RewardEntry(houseAddOns,    1157070, typeof(AlchemyStationDeed),   Expansion.LBR),
                    new RewardEntry(houseAddOns,    1157989, typeof(WritingDeskDeed),      Expansion.LBR),
                    new RewardEntry(houseAddOns,    1125529, typeof(TinkerBenchDeed),      Expansion.LBR),
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    new RewardEntry(miscellaneous,  1076158, typeof(WeaponEngravingTool), Expansion.SA),
                    new RewardEntry(houseAddOns,   1153535, typeof(DaviesLockerAddonDeed), Expansion.LBR),
                    new RewardEntry(houseAddOns,   1154583, typeof(GadgetryTableAddonDeed), Expansion.LBR),
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    new RewardEntry(monsterStatues, 1153592, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.Virtuebane),
                    new RewardEntry(etherealSteeds, 1076159, typeof(RideablePolarBear), Expansion.LBR),
                    new RewardEntry(houseAddOns,    1080549, typeof(WallBannerDeed), Expansion.LBR)
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    new RewardEntry(monsterStatues, 1080520, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.Harrower),
                    new RewardEntry(monsterStatues, 1080521, typeof(MonsterStatuette), Expansion.LBR, MonsterStatuetteType.Efreet),

                    new RewardEntry(cloaksAndRobes, 1080382, typeof(RewardCloak), Expansion.LBR, Pink, 1080382),
                    new RewardEntry(cloaksAndRobes, 1080380, typeof(RewardRobe), Expansion.LBR, Pink, 1080380),
                    ...
                    new RewardEntry(cloaksAndRobes, 1080378, typeof(RewardDress), Expansion.LBR, Pink, 1080378),
                    new RewardEntry(cloaksAndRobes, 1080383, typeof(RewardCloak), Expansion.LBR, Crimson, 1080383),
                    new RewardEntry(cloaksAndRobes, 1080381, typeof(RewardRobe), Expansion.LBR, Crimson, 1080381),
                    ...
                    new RewardEntry(cloaksAndRobes, 1080379, typeof(RewardDress), Expansion.LBR, Crimson, 1080379),

                    new RewardEntry(etherealSteeds, 1080386, typeof(EtherealCuSidhe), Expansion.LBR),

                    new RewardEntry(houseAddOns,    1080548, typeof(MiningCartDeed), Expansion.LBR),
                    new RewardEntry(houseAddOns,    1080397, typeof(AnkhOfSacrificeDeed), Expansion.LBR),
                    new RewardEntry(houseAddOns,    1150120, typeof(SkullRugAddonDeed), Expansion.LBR),
                    new RewardEntry(houseAddOns,    1150121, typeof(RoseRugAddonDeed), Expansion.LBR),
                    new RewardEntry(houseAddOns,    1150122, typeof(DolphinRugAddonDeed), Expansion.LBR),
                    new RewardEntry(houseAddOns,    1157996, typeof(KoiPondDeed), Expansion.LBR),
                    new RewardEntry(houseAddOns,    1158881, typeof(WaterWheelDeed), Expansion.LBR),
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    new RewardEntry(etherealSteeds, 1113908, typeof(EtherealReptalon), Expansion.LBR),
                ...
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    new RewardEntry(etherealSteeds, 1113813, typeof(EtherealHiryu), Expansion.LBR),
                    ...
                    new RewardEntry(miscellaneous, 1072619, typeof(ParrotPerchAddonDeed)),
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                ...
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    ...
                    new RewardEntry(etherealSteeds, 1155723, typeof(EtherealAncientHellHound), Expansion.SA),
                    new RewardEntry(etherealSteeds, 1157081, typeof(EtherealTarantula), Expansion.SA),
                    new RewardEntry(etherealSteeds, 1157081, typeof(EtherealWarBoar), Expansion.SA),

                    new RewardEntry(houseAddOns,    1153491, typeof(GardenShedDeed), Expansion.LBR),
                }),
                new RewardList(RewardInterval, 1, new RewardEntry[]
                {
                    new RewardEntry(etherealSteeds, 1157995, typeof(EtherealSerpentineDragon), Expansion.SA),

                    new RewardEntry(miscellaneous, 1155684, typeof(PowerScrollBook)),
                }),
            };
        }
        ...
        public static void Initialize()
        {
            ...
            CommandSystem.Register("Rewards", AccessLevel.Player, new CommandEventHandler(Rewards_OnCommand));
        }

        private static void Rewards_OnCommand(CommandEventArgs e)
        {
            PlayerMobile player = e.Mobile as PlayerMobile;

            if (player != null)
            {
                player.CloseGump(typeof(RewardNoticeGump));
                player.SendGump(new RewardNoticeGump(player));
            }
        }
