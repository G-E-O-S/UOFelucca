...
{
    [CorpseName("a proceratosaurus corpse")]
    public class Proceratosaurus : BaseCreature
    {
        public override bool AttacksFocus { get { return !Controlled; } }

        [Constructable]
        public Proceratosaurus()
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, .2, .4)
        {
            Name = "a proceratosaurus";
            Body = 1286;
            BaseSoundID = 0x275;
        ...
        public Proceratosaurus(Serial serial)
            : base(serial)
        {
        }
