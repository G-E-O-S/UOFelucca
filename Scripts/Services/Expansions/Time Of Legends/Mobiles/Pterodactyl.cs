...
{
    [CorpseName("a pterodactyl corpse")]
    public class Pterodactyl : BaseCreature
    {
        public override bool AttacksFocus { get { return !Controlled; } }

        [Constructable]
        public Pterodactyl() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, .2, .4)
        {
            Name = "a pterodactyl";
            Body = 1291;
            BaseSoundID = 362;
        ...
        public override int DragonBlood { get { return 0; } }
        public override int Meat { get { return 5; } }
        public override int Hides { get { return 11; } }
        public override int TreasureMapLevel { get { return 2; } }

        public Pterodactyl(Serial serial) : base(serial)
        {
        }
