    ...
    public static class TreasureMapInfo
    {
        ...
        public static int ConvertLevel(int level)
        {
            ...
            switch (level)
            {
                ...
                case 2: return (int)TreasureLevel.Stash;
                case 3: return (int)TreasureLevel.Supply;
                case 4: return (int)TreasureLevel.Cache;
                case 5: return (int)TreasureLevel.Hoard;
                case 6: return (int)TreasureLevel.Trove;
        ...
        public static Type[][] _SpecialSupplyLoot = new Type[][]
            {
                new Type[] { typeof(LegendaryMapmakersGlasses), typeof(ManaPhasingOrb), typeof(RuinedSashOfWarding), typeof(ShieldEngravingTool), null },
                new Type[] { typeof(ForgedPardon), typeof(LegendaryMapmakersGlasses), typeof(ManaPhasingOrb), typeof(RuinedSashOfWarding), typeof(SkeletonKey), typeof(MasterSkeletonKey), typeof(SurgeShield) },
                new Type[] { typeof(LegendaryMapmakersGlasses), typeof(ManaPhasingOrb), typeof(RuinedSashOfWarding) },
                new Type[] { typeof(LegendaryMapmakersGlasses), typeof(ManaPhasingOrb), typeof(RuinedSashOfWarding), typeof(TastyTreat) },
                new Type[] { typeof(LegendaryMapmakersGlasses), typeof(ManaPhasingOrb), typeof(RuinedSashOfWarding) },
            };
