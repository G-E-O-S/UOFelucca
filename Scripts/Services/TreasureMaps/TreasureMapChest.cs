...
namespace Server.Items
{
    public class TreasureMapChest : LockableContainer
    {
        ...
        private static readonly Type[] m_Artifacts = new Type[]
        {
            ...
            typeof(CavortingClub), typeof(DreadPirateHat), typeof (RarePetDye),
            ...
            typeof(AdmiralsHeartyRum), typeof(AbyssalCloth), typeof(AbyssalHairDye),
            typeof(ForgedPardon), typeof(DexOrb), typeof(RuinedSashOfWarding),
            typeof(SurgeShield), typeof(CoffinPiece), typeof(MasterSkeletonKey), typeof(AntiqueWeddingDress),
            typeof(KelpWovenLeggings), typeof(RunedDriftwoodBow), typeof(ValkyrieArmor), typeof(GrapeVine),
            typeof(LargeFishingNet), typeof(DaviesLockerAddonDeed), typeof(AbyssalHairDye), typeof(OrcChiefHelm),
            typeof(RoyalArtistryNecklace), typeof(GrandRangerBracelet), typeof(MasterFinesseRing), typeof(AncientMasteryEarrings),            
            typeof(RepairBenchDeed), typeof (WoodworkersBenchDeed), typeof(Quiver),            
            typeof(IntOrb), typeof(UOFeluccaPhoenixGloves), typeof(UOFeluccaPhoenixGorget),
            typeof(UOFeluccaPhoenixHelm), typeof(UOFeluccaPhoenixLegs), typeof(UOFeluccaPhoenixSleeves),
            typeof(UOFeluccaPhoenixTunic), typeof(UOFeluccaRangerGloves), typeof(UOFeluccaRangerGorget),
            typeof(UOFeluccaRangerHelm), typeof(UOFeluccaRangerLegs), typeof(UOFeluccaRangerTunic),
            typeof(UOFeluccaRangerSleeves), typeof(NightmareGloves), typeof (NightmareGorget), typeof (NightmareHelm),
            typeof(NightmareLegs), typeof(NightmareSleeves), typeof (NightmareTunic), typeof (EvilSpellbook),
            typeof(EvilCandle), typeof(EvilLantern), typeof(EvilTorch), typeof(EvilCloth), typeof(HearthOfHomeFireDeed),
            typeof(UOFeluccaDaemonGloves), typeof(UOFeluccaDaemonGorget), typeof (UOFeluccaDaemonHelm),
            typeof(UOFeluccaDaemonLegs), typeof(UOFeluccaDaemonSleeves), typeof(UOFeluccaDaemonTunic),
            typeof(AncientMinerApron), typeof(AncientMinerBoots), typeof(AncientMinerCap), typeof(AncientMinerLantern),
            typeof(AncientMinerPickaxe), typeof(ScavengerIngot), typeof(GargishTotemDeed), typeof(Shield25), typeof(Painting1),
            typeof(Painting2), typeof(Painting3), typeof(Painting4), typeof(Painting5), typeof(Painting6), typeof(Painting7),
            typeof(Painting8), typeof(Painting9), typeof(Painting10), typeof(Painting11), typeof(Painting12), typeof(Painting13),
            typeof(Painting14), typeof(Painting15), typeof(DeathStatue1), typeof(DeathStatue2), typeof(GoldenCandelabra1Deed),
            typeof(GoldenCandelabra2Deed)
        };
        ...
        {
            typeof(ForgedPardon), typeof(RuinedSashOfWarding), typeof(SurgeShield)
        };
        ...
        {
            typeof(AbyssalCloth), typeof(PetLeash), typeof(PetBondingPotion)
        ...
        public TreasureMapChest(Mobile owner, int level, bool temporary)
            : base(0xA308) // changed from 0xE40
        {
            Owner = owner;
            Level = level;
        ...
        public static void Fill(Mobile from, LockableContainer cont, int level, bool isSos)
        {
            ...
            if (level == 0)
            {
                ...
                if (Utility.RandomDouble() < 0.75)
                    cont.DropItem(new TreasureMap(0, Map.Felucca)); // HERE WHERE TRAMMEL MAPS WHERE STILL BEING FOUND? CHANGED TO FELUCCA
            }
            else
            {
                ...
                #region Gold
                cont.DropItem(new Gold(isSos ? level * 15000 : level * 10000)); // default 10000 : 5000
                #endregion               
                ...
                if (isSos)
                {
                    switch(level)
                    {
                        ...
                        case 0:
                        case 1: count = Utility.RandomMinMax(2, 4); break; // changed from 2 6
                        case 2: count = Utility.RandomMinMax(6, 8); break; // changed from 10 15
                    }
                }
                else
                {
                    count = level * 2; // default 5
                }
            ...
            {
                count = level == 0 ? 12 : Utility.RandomMinMax(10, 20) * (level + 1); // default 40, 60
            }
        ...
        public override void OnItemLifted(Mobile from, Item item)
        {
            ...
            if (notYetLifted)
            {
                ...
                if (0.00 >= Utility.RandomDouble()) // 5% chance to spawn a new monster
                {
