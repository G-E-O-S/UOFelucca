        ...
        private static Type[] m_VirtueArtifacts = new Type[]
            {
                ...
                typeof( SpiritualityHelm ), typeof( HonorLegs ), typeof( SacrificeSollerets ), typeof(EvilCloth), typeof(ShadowCloth),
                typeof(BloodCloth), typeof(ClothingBlessDeed), typeof(UOFeluccaPhoenixTicket), typeof(SocketDeedPlusOne), typeof(OrcChiefHelm),
                typeof(TrammyBarstool), typeof(TrammyBarstool), typeof(ScavengerIngot), typeof(EvilBackpackDye), typeof(MaskOfInsight),
                typeof(EvilBeardDye), typeof(BoneContainer1), typeof(BoneContainer2), typeof(BoneContainer3), typeof(BoneContainer4),
                typeof(BoneContainer5), typeof(NightmareHelm), typeof(NightmareLegs), typeof(NightmareGloves), typeof(NightmareGorget),
                typeof(NightmareSleeves), typeof(UOFeluccaRangerGloves), typeof(UOFeluccaRangerGorget), typeof(UOFeluccaRangerHelm), 
                typeof(UOFeluccaDaemonGloves), typeof(UOFeluccaDaemonGloves), typeof(UOFeluccaDaemonHelm), typeof(UOFeluccaDaemonLegs),
                typeof(UOFeluccaDaemonTunic), typeof(UOFeluccaRangerLegs), typeof(UOFeluccaRangerSleeves), typeof(UOFeluccaRangerTunic),
