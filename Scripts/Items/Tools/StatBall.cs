...
namespace Server.Items
{
    public class StatBallGump : Gump
    {
        ...
        public StatBallGump(PlayerMobile from, StatBall ball) : base(150, 250)
        {
            ...
            this.AddLabel(200, 67, 1160, "a 225 Statball");
            ...
            //this.AddLabel(114, 300, 1152, "* Stat totals should equal ");
            //this.AddLabel(282, 300, 1152, m_From.StatCap.ToString() );
            //this.AddLabel(313, 300, 1152, "*");

            this.AddLabel(114, 221, 1152, "*Stats total must equal 225*");
