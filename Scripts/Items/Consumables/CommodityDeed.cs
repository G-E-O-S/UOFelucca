...
namespace Server.Items
{
    ...
    public class CommodityDeed : Item
    {
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            if (Commodity != null && Commodity is ICommodity)
                from.Send(new MessageLocalizedAffix(
                                        ...
                                        0x3B2,
                                        3,
                                        (Commodity.Name == null) ? ((ICommodity)Commodity).Description : null,
                                        (Commodity.Name != null) ? Commodity.Name : null,
                                        AffixType.Append,
                                        String.Format(": {0}", Commodity.Amount),
                                        null)
                                        );
