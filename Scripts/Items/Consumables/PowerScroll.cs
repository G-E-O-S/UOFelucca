...
namespace Server.Items
{
    public class PowerScroll : SpecialScroll
    {
        ...
        public PowerScroll()
            : this(Skills[Utility.Random(Skills.Count)], 100 + (Utility.RandomList(105, 110, 115, 120)))   
        {
        }
        ...
        * You can view your maximum statistic value in your statistics window. */
        ...
        public override bool CanUse(Mobile from)
        {
            ...
            if (skill.Base < Value - 5)
            {
                from.SendMessage("You must first raise your skills further", GetNameLocalized());
                return false;
            }
