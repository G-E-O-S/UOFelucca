        ...
        public void Mark(Mobile m)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    setDesc = true;
                    /*int x = m_House.BanLocation.X + 1;
                    int y = m_House.BanLocation.Y + 1;
                    int z = m_House.BanLocation.Z;
                    Console.WriteLine(m_House.BanLocation.X + " " + m_House.BanLocation.Y + " " + m_House.BanLocation.Z);
