...
namespace Server.Items
{
    public class Runebook : Item, ISecurable, ICraftable
    {
        ...
        public static readonly TimeSpan UseDelay = TimeSpan.FromSeconds(0.0);
        ...
        {
            if (from.InRange(GetWorldLocation(), (Core.ML ? 3 : 2)) && CheckAccess(from))
            {
        ...
        public virtual int OnCraft(int quality, bool makersMark, Mobile from, CraftSystem craftSystem, Type typeRes, ITool tool, CraftItem craftItem, int resHue)
        {
            ...
            MaxCharges = (Core.LBR ? charges * 5 : charges);
