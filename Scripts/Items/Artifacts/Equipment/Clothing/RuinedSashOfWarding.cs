...
namespace Server.Items
{
    ...
    public class RuinedSashOfWarding : BodySash
    {
        ...
        public RuinedSashOfWarding(Serial serial) : base(serial)
        {
        }
    ...
    public class GargishRunedSashOfWarding : RuinedSashOfWarding
    {
