...
namespace Server.Items
{
    ...
    public class PMList
    {
        ...
        public static readonly PMList Felucca = new PMList(
            ...
            new[]
            {
                ...
                new PMEntry(new Point3D(5349, 3955, 7), 1011058), // Delucia
                new PMEntry(new Point3D(3745, 2511, 48), 1076027), // Ocllo
                new PMEntry(new Point3D(1341, 1904, 0), 1076090) // 1076090
            });
    ...
    public class MoongateGump : Gump
    {
            ...
            : base(100, 100)
        {
            ...
            AddBackground(0, 0, 180, 400, 5054); // 5054

            AddButton(10, 350, 4005, 4007, 1, GumpButtonType.Reply, 0);
            AddHtmlLocalized(45, 350, 140, 25, 1011036, false, false); // OKAY // default (310)

            AddButton(10, 375, 4005, 4007, 0, GumpButtonType.Reply, 0);
            AddHtmlLocalized(45, 375, 140, 25, 1011012, false, false); // CANCEL // default (340)
            ...
            /*for (var i = 0; i < checkLists.Length; ++i)
			{
				...
				AddHtmlLocalized(30, 35, 10, 20, checkLists[i].Number, false, false);
			}*/
        ...
        private void RenderPage(int index, int offset)
        {
            ...
            {
                AddRadio(10, 45 + (i * 25), 210, 211, false, (index * 100) + i);
                AddHtmlLocalized(35, 45 + (i * 25), 150, 20, entries[i].Number, false, false);
            }
        }
    }
}
