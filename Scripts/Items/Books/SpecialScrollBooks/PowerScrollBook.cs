...
namespace Server.Items
{
    ...
    public class PowerScrollBook : BaseSpecialScrollBook
    {
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            this.LabelTo(from, $"Capacity - {Items.Count}/{Capacity}");
        }
        ...
        public static void Initialize()
        {
            ...
            //_SkillInfo[SkillCat.Combat] = new List<SkillName>() { SkillName.Anatomy, SkillName.Archery, SkillName.Fencing, SkillName.Focus, SkillName.Healing, SkillName.Macing, SkillName.Parry, SkillName.Swords, SkillName.Tactics, SkillName.Throwing, SkillName.Wrestling }; // SkillName.Focus
            _SkillInfo[SkillCat.TradeSkills] = new List<SkillName>() { SkillName.Mining, SkillName.Blacksmith, SkillName.Tailoring, SkillName.Carpentry, SkillName.Tinkering }; // SkillName.Fletching, SkillName.Cooking, SkillName.Alchemy, SkillName,Inscription
            ...
            _SkillInfo[SkillCat.Wilderness] = new List<SkillName>() { SkillName.AnimalLore, SkillName.AnimalTaming, SkillName.Veterinary }; // SkillName.Fishing
