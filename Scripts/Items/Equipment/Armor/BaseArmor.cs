    ...
    public abstract class BaseArmor : Item, IScissorable, IFactionItem, ICraftable, IWearableDurability, IResource, ISetItem, IVvVItem, IOwnerRestricted, ITalismanProtection, IEngravable, IArtifact, ICombatEquipment, IQuality
    {
        ...
        */
        ...
        public virtual int OnHit(BaseWeapon weapon, int damageTaken)
        {
            ...
            double chance = NegativeAttributes.Antique > 0 ? 40 : 10; // default 80 : 25
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (Core.AOS && (prop = m_AosArmorAttributes.SelfRepair) != 0)
        ...
        public virtual int OnCraft(int quality, bool makersMark, Mobile from, CraftSystem craftSystem, Type typeRes, ITool tool, CraftItem craftItem, int resHue)
        {
            ...
            {
                DistributeExceptionalBonuses(from, (tool is BaseRunicTool ? 6 : Core.SE ? 15 : 14));
            }
            ...
            // Set the hue of the crafted item based on the hue of the resource
            Hue = resHue;
