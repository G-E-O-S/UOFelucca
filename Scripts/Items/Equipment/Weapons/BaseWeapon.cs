    ...
    public abstract class BaseWeapon : Item, IWeapon, IFactionItem, IUsesRemaining, ICraftable, ISlayer, IDurability, ISetItem, IVvVItem, IOwnerRestricted, IResource, IArtifact, ICombatEquipment, IEngravable, IQuality
    {
        ...
        */
        ...
        public virtual void OnHit(Mobile attacker, IDamageable damageable, double damageBonus)
        {
            ...
            double chance = NegativeAttributes.Antique > 0 ? 2 : 0; // default 5 : 0
            ...
            if (acidicTarget || (defender != null && splintering) || Utility.Random(40) <= chance)
            {
                ...
                else
                {
                    ...
                    double durabilityPercentage = (double)HitPoints / (double)MaxHitPoints;

                    double lowDurabilityThreshold = 0.10;

                    if (durabilityPercentage < lowDurabilityThreshold)
                    {
                        if (Parent is Mobile)
                            ((Mobile)Parent).Emote("Your weapon is damaged!");
                    }
                }
            }
            ...
            */
            ...
            if (RuinedSashOfWarding.IsUnderEffects(defender, WardingEffect.WeaponDamage))
                percentageBonus -= 10;
            #endregion
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (RequiredRace == Race.Elf && ExpansionInfo.CoreExpansion.SupportedFeatures.HasFlag(CharacterListFlags.ML))
                list.Add(1075086); // Elves Only
            else if (RequiredRace == Race.Gargoyle && ExpansionInfo.CoreExpansion.SupportedFeatures.HasFlag(CharacterListFlags.SA))
            ...
            if (Core.AOS && (prop = m_AosWeaponAttributes.SelfRepair) != 0)
            {
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            this.LabelTo(from, "Durability - " + HitPoints.ToString() + "/" + MaxHitPoints.ToString());
