...
namespace Server.Items
{
    ...
    {
        public static readonly double MaxBardingDifficulty = 140.0; // default 160
        ...
        public static double GetBaseDifficulty(Mobile targ)
        {
            ...
            - Summoning Undead
            */
            double val = (targ.HitsMax * 1.0) + targ.StamMax + targ.ManaMax; // default 1.6

            val += targ.SkillsTotal / 6; // default 10
            ...
            if (Core.LBR && val > MaxBardingDifficulty) // default SE
