...
{
    public class UOFeluccaPhoenixSleeves : BaseArmor, IRepairable
    {
        public CraftSystem RepairSystem { get { return DefBlacksmithy.CraftSystem; } }

        [Constructable]
        public UOFeluccaPhoenixSleeves()
            : base(0x13EE)
        {
            this.Attributes.BonusStr = 1;
            this.Name = "Phoenix Sleeves";
        ...
        public UOFeluccaPhoenixSleeves(Serial serial)
            : base(serial)
        {
        }
