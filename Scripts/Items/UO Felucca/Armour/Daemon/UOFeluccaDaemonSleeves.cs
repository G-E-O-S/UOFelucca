...
namespace Server.Items
{
    ...
    public class UOFeluccaDaemonSleeves : BaseArmor, IRepairable
    {
        public CraftSystem RepairSystem { get { return DefTailoring.CraftSystem; } }

        public override bool IsArtifact { get { return true; } }
        [Constructable]
        public UOFeluccaDaemonSleeves()
            : base(0x144E)
        {
            this.Weight = 1.0;
            this.Hue = Utility.RandomList(1175, 1109, 1910, 1194);
            this.Name = "Daemon Sleeves";
        ...
        public UOFeluccaDaemonSleeves(Serial serial)
            : base(serial)
        {
        }
