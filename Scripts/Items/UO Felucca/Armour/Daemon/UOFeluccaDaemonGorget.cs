...
namespace Server.Items
{
    ...
    public class UOFeluccaDaemonGorget : BaseArmor, IRepairable
    {
        public CraftSystem RepairSystem { get { return DefTailoring.CraftSystem; } }

        public override bool IsArtifact { get { return true; } }
        [Constructable]
        public UOFeluccaDaemonGorget()
            : base(0x2B0E)
        {
            this.Weight = 1.0;
            this.Hue = Utility.RandomList(1175, 1109, 1910);
            this.Name = "Daemon Gorget";
        ...
        public UOFeluccaDaemonGorget(Serial serial)
            : base(serial)
        {
        }
