...
namespace Server.Items
{
    ...
    public class PureWhiteCloth : Item, IScissorable, IDyable, ICommodity
    {
        [Constructable]
        public PureWhiteCloth()
            : this(1)
        {
        }

        [Constructable]
        public PureWhiteCloth(int amount)
            : base(0x1767)
        {
            this.Stackable = true;
            this.Amount = amount;
        ...
        public PureWhiteCloth(Serial serial)
            : base(serial)
        {
        }
