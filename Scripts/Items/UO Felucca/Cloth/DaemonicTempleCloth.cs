...
namespace Server.Items
{
    ...
    public class DaemonicTempleCloth : Item, IScissorable, IDyable, ICommodity
    {
        [Constructable]
        public DaemonicTempleCloth()
            : this(1)
        {
        }

        [Constructable]
        public DaemonicTempleCloth(int amount)
            : base(0x1767)
        {
            this.Stackable = true;
            this.Amount = amount;
        ...
        public DaemonicTempleCloth(Serial serial)
            : base(serial)
        {
        }
