...
namespace Server.Items
{
    ...
    public class PaintedCavesCloth : Item, IScissorable, IDyable, ICommodity
    {
        [Constructable]
        public PaintedCavesCloth()
            : this(1)
        {
        }

        [Constructable]
        public PaintedCavesCloth(int amount)
            : base(0x1767)
        {
            this.Stackable = true;
            this.Amount = amount;
        ...
        public PaintedCavesCloth(Serial serial)
            : base(serial)
        {
        }
