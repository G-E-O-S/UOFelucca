...
namespace Server.Items
{
    ...
    public class PrismOfLightCloth : Item, IScissorable, IDyable, ICommodity
    {
        [Constructable]
        public PrismOfLightCloth()
            : this(1)
        {
        }

        [Constructable]
        public PrismOfLightCloth(int amount)
            : base(0x1767)
        {
            this.Stackable = true;
            this.Amount = amount;
        ...
        public PrismOfLightCloth(Serial serial)
            : base(serial)
        {
        }
