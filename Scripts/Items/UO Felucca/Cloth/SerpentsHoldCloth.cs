...
namespace Server.Items
{
    ...
    public class SerpentsHoldCloth : Item, IScissorable, IDyable, ICommodity
    {
        [Constructable]
        public SerpentsHoldCloth()
            : this(1)
        {
        }

        [Constructable]
        public SerpentsHoldCloth(int amount)
            : base(0x1767)
        {
            this.Stackable = true;
            this.Amount = amount;
        ...
        public SerpentsHoldCloth(Serial serial)
            : base(serial)
        {
        }
