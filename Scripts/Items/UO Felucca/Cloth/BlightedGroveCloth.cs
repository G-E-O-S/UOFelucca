...
namespace Server.Items
{
    ...
    public class BlightedGroveCloth : Item, IScissorable, IDyable, ICommodity
    {
        [Constructable]
        public BlightedGroveCloth()
            : this(1)
        {
        }

        [Constructable]
        public BlightedGroveCloth(int amount)
            : base(0x1767)
        {
            this.Stackable = true;
            this.Amount = amount;
        ...
        public BlightedGroveCloth(Serial serial)
            : base(serial)
        {
        }
