...
namespace Server.Items
{
    ...
    public class TerathanKeepCloth : Item, IScissorable, IDyable, ICommodity
    {
        [Constructable]
        public TerathanKeepCloth()
            : this(1)
        {
        }

        [Constructable]
        public TerathanKeepCloth(int amount)
            : base(0x1767)
        {
            this.Stackable = true;
            this.Amount = amount;
        ...
        public TerathanKeepCloth(Serial serial)
            : base(serial)
        {
        }
