...
namespace Server.Items
{
    ...
    public class SanctuaryCloth : Item, IScissorable, IDyable, ICommodity
    {
        [Constructable]
        public SanctuaryCloth()
            : this(1)
        {
        }

        [Constructable]
        public SanctuaryCloth(int amount)
            : base(0x1767)
        {
            this.Stackable = true;
            this.Amount = amount;
        ...
        public SanctuaryCloth(Serial serial)
            : base(serial)
        {
        }
