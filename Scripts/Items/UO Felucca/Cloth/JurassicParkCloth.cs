...
namespace Server.Items
{
    ...
    public class JurassicParkCloth : Item, IScissorable, IDyable, ICommodity
    {
        [Constructable]
        public JurassicParkCloth()
            : this(1)
        {
        }

        [Constructable]
        public JurassicParkCloth(int amount)
            : base(0x1767)
        {
            this.Stackable = true;
            this.Amount = amount;
        ...
        public JurassicParkCloth(Serial serial)
            : base(serial)
        {
        }
