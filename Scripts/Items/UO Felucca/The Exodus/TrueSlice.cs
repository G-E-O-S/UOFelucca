...
namespace Server.Items
{
    ...
    public class TrueSlice : BaseMeleeWeapon, Server.Engines.Craft.IRepairable
    {
                ...
                case 0:
                    ...
                    XmlAttach.AttachTo(this,
                        new XmlCustomAttacks(
                            ...
                            {
                            XmlCustomAttacks.SpecialAttacks.CriticalHit
                            }
                        )
                    );
                    break;
        ...
        public TrueSlice(Serial serial) : base(serial)
        {
        }
        ...
        private class InfoEntry : ContextMenuEntry
        {
            ...
            {
                m_Player.SendGump(new TrueSliceGump());
            }

            private class TrueSliceGump : Gump
            {
                public TrueSliceGump() : base(0, 360)
                {
                    this.Closable = true;
                    ...
                    this.AddLabel(20, 90, 1153, "True Slice (Swordsmanship) - This ancient weapon was owned");
                    this.AddLabel(20, 110, 1153, "by a Samurai who never met an equal. He ended up dying of");
                    this.AddLabel(20, 130, 1153, "old age in the midst of a huge battle! It has the ability to");
                    this.AddLabel(20, 150, 1153, "cut clean through your opponent's soul, dealing huge damage.");

                    this.AddLabel(20, 190, 1153, "On Use - Critical Hit");
                    this.AddLabel(20, 210, 1153, "Damage Bonus - 200%");
                    this.AddLabel(20, 230, 1153, "Requirements - GM Swordsmanship");
