...
namespace Server.Items
{
    ...
    public class AncientDagger : BaseMeleeWeapon, Server.Engines.Craft.IRepairable
    {

        public CraftSystem RepairSystem { get { return DefBlacksmithy.CraftSystem; } }

        [Constructable]
        public AncientDagger()
            : base(0x2D21)
        {
            this.Weight = 1.0;
                ...
                case 0:
                    ...
                    XmlAttach.AttachTo(this,
                        new XmlCustomAttacks(
                            ...
                            {
                            XmlCustomAttacks.SpecialAttacks.PlagueTouch
                            }
                        )
                    );
                    break;
        ...
        public AncientDagger(Serial serial) : base(serial)
        {
        }
        ...
        private class InfoEntry : ContextMenuEntry
        {
            ...
            {
                m_Player.SendGump(new AncientDaggerGump());
            }

            private class AncientDaggerGump : Gump
            {
                public AncientDaggerGump() : base(0, 360)
                {
                    this.Closable = true;
                    ...
                    this.AddLabel(20, 90, 1153, "Ancient Dagger (Fencing) - This weapon was carried by the");
                    this.AddLabel(20, 110, 1153, "first ever thief. She was known to break into royal villas");
                    this.AddLabel(20, 130, 1153, "and steal dangerous poisons which would then be applied to");
                    this.AddLabel(20, 150, 1153, "the blade. It has the ability to plague your opponent!");

                    this.AddLabel(20, 190, 1153, "On Use - Plague Touch");
                    this.AddLabel(20, 210, 1153, "Poison Level - Deadly");
                    this.AddLabel(20, 230, 1153, "Requirements - GM Fencing");
