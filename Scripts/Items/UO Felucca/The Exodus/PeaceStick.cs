...
namespace Server.Items
{
    ...
    public class PeaceStick : BaseMeleeWeapon, Server.Engines.Craft.IRepairable
    {
                ...
                case 0:
                    ...
                    XmlAttach.AttachTo(this,
                        new XmlCustomAttacks(
                            ...
                            {
                            XmlCustomAttacks.SpecialAttacks.SilenceTarget
                            }
                        )
                    );
                    break;
        ...
        public PeaceStick(Serial serial) : base(serial)
        {
        }
        ...
        private class InfoEntry : ContextMenuEntry
        {
            ...
            {
                m_Player.SendGump(new PeaceStickGump());
            }

            private class PeaceStickGump : Gump
            {
                public PeaceStickGump() : base(0, 360)
                {
                    this.Closable = true;
                    ...
                    this.AddLabel(20, 90, 1153, "Peace Stick (Mace Fighting) - This ancient weapon was");
                    this.AddLabel(20, 110, 1153, "owned by a friendly wizard who helped save his world from");
                    this.AddLabel(20, 130, 1153, "darkness. He gave it to his little friend before passing");
                    this.AddLabel(20, 150, 1153, "away. It has the ability to silence & stun your foe.");

                    this.AddLabel(20, 190, 1153, "On Use - Target Silence");
                    this.AddLabel(20, 210, 1153, "Stun Duration - 10 Seconds");
                    this.AddLabel(20, 230, 1153, "Requirements - GM Peacemaking");
