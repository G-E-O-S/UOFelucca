...
namespace Server.Items
{
    ...
    public class BodyHarvester : BaseMeleeWeapon, Server.Engines.Craft.IRepairable
    {

        public CraftSystem RepairSystem { get { return DefBlacksmithy.CraftSystem; } }

        [Constructable]
        public BodyHarvester()
            : base(0x2D28)
        {
            this.Weight = 12.0;
                ...
                case 0:
                    ...
                    XmlAttach.AttachTo(this,
                        new XmlCustomAttacks(
                            ...
                            {
                            XmlCustomAttacks.SpecialAttacks.BloodDrink
                            }
                        )
                    );
                    break;
        ...
        public BodyHarvester(Serial serial) : base(serial)
        {
        }
        ...
        private class InfoEntry : ContextMenuEntry
        {
            ...
            {
                m_Player.SendGump(new BodyHarvesterGump());
            }

            private class BodyHarvesterGump : Gump
            {
                public BodyHarvesterGump() : base(0, 360)
                {
                    this.Closable = true;
                    ...
                    this.AddLabel(20, 90, 1153, "Body Harvester (Lumberjacking) - This ancient weapon was");
                    this.AddLabel(20, 110, 1153, "wielded by a mighty warrior who fought battles across all");
                    this.AddLabel(20, 130, 1153, "of Felucca. Since then it has only been seen in the finest");
                    this.AddLabel(20, 150, 1153, "museums. It has the ability to harvest the life of your foe!");

                    this.AddLabel(20, 190, 1153, "On Use - Blood Drink");
                    this.AddLabel(20, 210, 1153, "Health Restore - 100%");
                    this.AddLabel(20, 230, 1153, "Requirements - GM Lumberjacking");
