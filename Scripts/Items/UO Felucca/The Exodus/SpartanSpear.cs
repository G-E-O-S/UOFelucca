...
namespace Server.Items
{
    ...
    public class SpartanSpear : BaseMeleeWeapon, Server.Engines.Craft.IRepairable
    {
                ...
                case 0:
                    ...
                    XmlAttach.AttachTo(this,
                        new XmlCustomAttacks(
                            ...
                            {
                            XmlCustomAttacks.SpecialAttacks.CriticalHit2
                            }
                        )
                    );
                    break;
        ...
        public SpartanSpear(Serial serial) : base(serial)
        {
        }
        ...
        private class InfoEntry : ContextMenuEntry
        {
            ...
            {
                m_Player.SendGump(new SpartanSpearGump());
            }

            private class SpartanSpearGump : Gump
            {
                public SpartanSpearGump() : base(0, 360)
                {
                    this.Closable = true;
                    ...
                    this.AddLabel(20, 90, 1153, "Spartan Spear (Fencing) - This ancient weapon was owned");
                    this.AddLabel(20, 110, 1153, "by a King who ruled over a militaristic society. He fell");
                    this.AddLabel(20, 130, 1153, "in battle still grasping this spear. It has the ability to");
                    this.AddLabel(20, 150, 1153, "pierce clean through your enemy, dealing huge damage.");
