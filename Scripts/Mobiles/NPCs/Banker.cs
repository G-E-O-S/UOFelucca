                        ...
                        case 0x0000: // *withdraw*
                            {
                                ...
                                if (split.Length >= 2)
                                {
                                    ...
                                    if ((!Core.ML && amount > 60000) || (Core.ML && amount > 60000))
                                    {
                                    ...
                                    if (split.Length >= 2)
                                    {
                                        ...
                                        else
                                        {
                                            if (Withdraw(e.Mobile, amount))
                                            {
                                                ...
                                                var pack = e.Mobile.Backpack; // Get the player's backpack

                                                if (pack != null && pack.TryDropItem(e.Mobile, check, false))
                                                {
                                                    // Into your backpack I have placed a check in the amount of:
                                                    vendor.Say(1042673, AffixType.Append, amount.ToString("#,0"), "");
                                                }
                                                else
                                                {
                                                    // There's not enough room in your backpack for the check!
                                                    vendor.Say(500389);
                                                    check.Delete();
                                                }
                                            }
                                            ...
                                            {
                                                // You don't have enough gold to create this check!
                                                vendor.Say(500384);
                                            }
                                        }                                                                        
                                    }
