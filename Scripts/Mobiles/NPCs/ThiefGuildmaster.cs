...
namespace Server.Mobiles
{
    public class ThiefGuildmaster : BaseGuildmaster
    {
        ...
        public override TimeSpan JoinAge
        {
            get
            {
                return Siege.SiegeShard ? TimeSpan.FromDays(0.0) : TimeSpan.FromDays(2.0); // default 7
            }
        }
        public override TimeSpan JoinGameAge
        {
            get
            {
                return Siege.SiegeShard ? TimeSpan.FromDays(0.0) : TimeSpan.FromDays(1.0); // default 2
            }
        }
