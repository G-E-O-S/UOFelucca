...
namespace Server.Mobiles
{
    ...
    public class DaemonicNightmare : BaseMount
    {
        [Constructable]
        public DaemonicNightmare()
            : this("a daemonic nightmare")
        {
        }

        [Constructable]
        public DaemonicNightmare(string name)
        ...
        public DaemonicNightmare(Serial serial)
            : base(serial)
        {
        }
