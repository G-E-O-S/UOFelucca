...
namespace Server.Mobiles
{
    public class EtherealMount : Item, IMount, IMountItem, IRewardItem
    {
        ...
        public override bool DisplayLootType { get { return Core.LBR; } } // default AOS
    ...
    public class EtherealTarantula : EtherealMount
    {
        ...
        {
            #region TOL
            if (from.NetState != null && !from.NetState.SupportsExpansion(Expansion.LBR)) // Changed from ML
            {
    ...
    public class EtherealLasher : EtherealMount
    {
        ...
        {
            #region TOL
            if (from.NetState != null && !from.NetState.SupportsExpansion(Expansion.LBR))
            {
                from.SendLocalizedMessage(1156139); // * You must upgrade to the Time of Legends in order to use this. *                               
                return false;
            }
