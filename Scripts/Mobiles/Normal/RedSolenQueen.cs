    ...
    public class RedSolenQueen : BaseCreature, IRedSolen
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            if (0.1 > Utility.RandomDouble())
                this.PackItem(new PowderOfTranslocation(2));
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (Utility.RandomDouble() < 0.50)
                c.DropItem(new PowderOfTranslocation(4));

            if (Utility.RandomDouble() < 0.08)
                c.DropItem(new BraceletOfBinding());
            if (Utility.RandomDouble() < 0.04)
                c.DropItem(new BallOfSummoning());
        ...
        public override void OnGotMeleeAttack(Mobile attacker)
        {
            ...
            if (this.Map != null && attacker != this && m_Laid == false && 0.20 > Utility.RandomDouble()) //  if (m_Talked == false)
            {
