...
namespace Server.Items
{
	public class CharityBox : LargeCrate
	{
		...
		private static void OnAdded(Mobile m, Item item)
		{
			...
			m.SendMessage("{0} was added to your Charity stock-pile.", label);
		}
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			using (var opl = new ExtendedOPL(list))
			{
				...
				opl.Add("Use: Browse the Charity".WrapUOHtmlColor(Color.LawnGreen));
				opl.Add("Use: Drop items inside to donate them!".WrapUOHtmlColor(Color.LawnGreen));
			}
		}
