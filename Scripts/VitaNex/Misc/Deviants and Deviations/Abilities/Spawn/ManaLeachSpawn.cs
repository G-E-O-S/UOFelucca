...
{
	public class ManaLeachSpawnDeviantAbility : SpawnDeviantAbility
	{
		public override string Name { get { return "Mana Leach Spawn"; } }

		public override DeviationFlags Deviations
		{
			get { return DeviationFlags.Elements | DeviationFlags.Faith | DeviationFlags.Nature; }
		}
		...
		{
			return new ManaLeach(deviant);
		}

		private class ManaLeach : DeviantSpawn
		{
			private EnergyExplodeEffect _Aura;
			private long _NextAura;

			public ManaLeach(BaseDeviant deviant)
