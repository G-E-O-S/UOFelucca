        ...
        static SlayerGroup()
        {
            ...
            humanoid.Super = new SlayerEntry
                (
                    ...
                    typeof(TheBeastOfWind), typeof(TheKingOfDespise),
                    typeof(ThePaintedLady), typeof(TheQueenOfWrong),
                    typeof(TheLadyOfIce)
                );
            ...
            undead.Super = new SlayerEntry
                (
                    ...
                    typeof(TheQueenOfCovetous), typeof(TheGuardianOfParoxysmus),
                    typeof(TheLordOfDeceit), typeof(Bael)
                );
            ...
            fey.Super = new SlayerEntry
                (
                    ...
                    typeof(FeralTreefellow), typeof(Lucifer),
                    typeof(TheKeeperOfLight)
                );
            ...
            elemental.Super = new SlayerEntry
                (
                    ...
                    typeof(CovetousWaterElemental), typeof(TheLordOfShame)
                );
            ...
            if (Core.AOS)
            {
                abyss.Super = new SlayerEntry
                    (
                        ...
                        typeof(Lifestealer), typeof(TheKingOfHythloth),
                        typeof(TheLordOfFire), typeof(KhalEldur)
                    );
            ...
            else
            {
                abyss.Super = new SlayerEntry
                    (
                        ...
                        typeof(TheHorrorOfKhaldun), typeof(TheLordOfFire),
                        typeof(TheKingOfHythloth)
                    );
                ...
                abyss.Entries = new SlayerEntry[]
                {
                    new SlayerEntry
                        (
                            ...
                            typeof(TheLordOfFire),  typeof(TheKingOfHythloth)
                        ),
            ...
            arachnid.Entries = new SlayerEntry[]
            {
                ...
                new SlayerEntry
                    (
                        ...
                        typeof(TerathanAvenger),    typeof(TerathanDrone),
                        typeof(TerathanMatriarch),  typeof(TerathanWarrior),
                        typeof(Anlorlem), typeof(TheGuardianOfTerathanKeep)
                    )
            };
            ...
            reptilian.Super = new SlayerEntry
                (
                    ...
                    typeof(TheKingOfDestard), typeof(TheGuardianOfTerathanKeep)
                );
            ...
            reptilian.Entries = new SlayerEntry[]
            {
                new SlayerEntry
                    (
                        ...
                        typeof(ColdDrake),          typeof(TheKingOfDestard)
                    ),
            ...
            dino.Super =
                new SlayerEntry(
                    ...
                    typeof(Dimetrosaur), typeof(Gallusaurus), 
                    typeof(Archaeosaurus), typeof(Najasaurus),
                    typeof(Pterodactyl), typeof(Raptor),
                    typeof(KomodoDragon), typeof(DragonTurtleHatchling),
                    typeof(DeepSeaSerpent), typeof(SabertoothedTiger),
                    typeof(KingCobra), typeof(Dilophosaurus),
                    typeof(Proceratosaurus), typeof(Saurosaurus),
                    typeof(Allosaurus), typeof(MyrmidexLarvae),
                    typeof(MyrmidexDrone), typeof(TRex),
