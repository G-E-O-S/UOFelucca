...
namespace Server.Misc
{
    ...
    {
        public static void MoveIntoContainer(Container container, Item it, Point3D p)
        {
            it.Location = p;
        }
    }
    ...
    public class CharacterCreation
    {
        ...
        private static void AddToBackpackPosition(Mobile from, Container cont, Item it, Point3D newPosition)
        {
            if (cont.TryDropItem(from, it, false))
            {
                it.Location = newPosition;
            }
        }
        ...
        private static void AddBackpack(Mobile m)
        {
            ...
            //PackItem(new BankCheck(15000));
            //PackItem(new Gold(2500));
            //PackItem(new HousePlacementTool());
            //PackItem(new Dagger());
            //PackItem(new Scissors());
            //PackItem(new BlackPearl(50));
            //PackItem(new Bloodmoss(50));
            //PackItem(new Garlic(50));
            //PackItem(new Ginseng(50));
            //PackItem(new MandrakeRoot(50));
            ...
            AddToBackpackPosition(m, pack, new SkillBallPlus(), new Point3D(x += step, y, 0));
            AddToBackpackPosition(m, pack, new StatBall(), new Point3D(x += step, y, 0));          
            AddToBackpackPosition(m, pack, new BankCheck(20000), new Point3D(x += step, y, 0));
            AddToBackpackPosition(m, pack, new Gold(20000), new Point3D(x += step, y, 0));
            AddToBackpackPosition(m, pack, new HousePlacementTool(), new Point3D(x += step, y, 0));
            AddToBackpackPosition(m, pack, new Spellbook(UInt64.MaxValue), new Point3D(x += step, y, 0));
            AddToBackpackPosition(m, pack, new NewbiedDagger(), new Point3D(x += step, y, 0));
            AddToBackpackPosition(m, pack, new NewbiedScissors(), new Point3D(x += step, y, 0));
            AddToBackpackPosition(m, pack, new EtherealHorse(), new Point3D(x += step, y, 0));
        }
                ...
                case 5: // Paladin
                    {
                        skills = new[]
                        {
                        new SkillNameValue(SkillName.Anatomy, 30), new SkillNameValue(SkillName.Swords, 30),
                        new SkillNameValue(SkillName.Healing, 30), new SkillNameValue(SkillName.Tactics, 30)
                    };
                ...
                case 6: //Samurai
                    {
                        skills = new[]
                        {
                        new SkillNameValue(SkillName.Tactics, 30), new SkillNameValue(SkillName.Swords, 30),
                        new SkillNameValue(SkillName.Anatomy, 30), new SkillNameValue(SkillName.Healing, 30)
                    };
                        break;
                    }
                case 7: //Ninja
                    {
                        skills = new[]
                        {
                        new SkillNameValue(SkillName.Healing, 30), new SkillNameValue(SkillName.Hiding, 30),
