...
namespace Server
{
    public class LootPack
    {
        ...
        #region Custom
        // Added for Support due to support of default loot option on ShadowDrake.cs
        // Shadow Drake is custom mobile that comes with FS:ATS
        ...
        public static readonly LootPack MageryRegs = new LootPack(new[] { new LootPackEntry(false, MageryRegItems, 100.00, 1) });
        #endregion
        ...
        public static readonly LootPackItem[] OldMagicItems = new[]
        {
            ...
            new LootPackItem(typeof(BaseShield), 1), new LootPackItem(typeof(BaseWand), 1)
        };
        #endregion
        ...
        public static readonly LootPack OldPoor =
            new LootPack(new[] { new LootPackEntry(true, Gold, 100.00, "1d50"), new LootPackEntry(false, Instruments, 0.02, 1) });

        public static readonly LootPack OldMeager =
            new LootPack(
                new[]
                {
                    new LootPackEntry(true, Gold, 100.00, "5d10+100"), new LootPackEntry(false, Instruments, 0.10, 1),
        ...
        public static readonly LootPack OldAverage =
            new LootPack(
                new[]
                {
                    new LootPackEntry(true, Gold, 100.00, "10d10+200"), new LootPackEntry(false, Instruments, 0.40, 1),
        ...
        public static readonly LootPack OldRich =
            new LootPack(
                new[]
                {
                    new LootPackEntry(true, Gold, 100.00, "10d10+600"), new LootPackEntry(false, Instruments, 1.00, 1),
        ...
        public static readonly LootPack OldFilthyRich =
            new LootPack(
                new[]
                {
                    new LootPackEntry(true, Gold, 100.00, "2d125+800"), new LootPackEntry(false, Instruments, 2.00, 1),
        ...
        public static readonly LootPack OldUltraRich =
            new LootPack(
                new[]
                {
                    new LootPackEntry(true, Gold, 100.00, "5d100+1000"), new LootPackEntry(false, Instruments, 2.00, 1),
        ...
        public static readonly LootPack OldSuperBoss =
            new LootPack(
                new[]
                {
                    new LootPackEntry(true, Gold, 100.00, "5d100+1500"), new LootPackEntry(false, Instruments, 2.00, 1),
                    new LootPackEntry(false, OldMagicItems, 100.00, 1, 1, 40, 100),
                    new LootPackEntry(false, OldMagicItems, 100.00, 1, 1, 40, 100),
                    new LootPackEntry(false, OldMagicItems, 100.00, 1, 1, 40, 100),
                    new LootPackEntry(false, OldMagicItems, 100.00, 1, 1, 50, 100),
    ...
    public class LootPackItem
    {
        ...
        public Item Construct(bool inTokuno, bool isMondain, bool isStygian)
        {
            try
            {
                ...
                else if (m_Type == typeof(BaseWand)) // wand
                {
