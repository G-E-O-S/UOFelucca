    ...
    public class MapDefinitions
    {
        public static void Configure()
        {
            ...
            */
            ...
            {
                RegisterMap(0, 0, 0, 7168, 4096, 3, "Felucca", MapRules.FeluccaRules); // CHANGE MAP SEASONS IN HERE
                RegisterMap(1, 1, 1, 7168, 4096, 4, "Trammel", MapRules.FeluccaRules);
                RegisterMap(2, 2, 2, 2304, 1600, 4, "Ilshenar", MapRules.FeluccaRules);
                RegisterMap(3, 3, 3, 2560, 2048, 4, "Malas", MapRules.FeluccaRules);
                RegisterMap(4, 4, 4, 1448, 1448, 4, "Tokuno", MapRules.FeluccaRules);
                RegisterMap(5, 5, 5, 1280, 4096, 4, "TerMur", MapRules.FeluccaRules);
            }
