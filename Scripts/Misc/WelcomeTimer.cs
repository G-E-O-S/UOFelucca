...
namespace Server.Misc
{
    ...
    public class WelcomeTimer : Timer
	{
		...
		{
			"Welcome to " + ServerList.ServerName + "! Thank you for choosing to game with us.", //
			"Please visit the shards website, 'uofelucca.com' to join the Discord server & stay up to date."
		...
		public WelcomeTimer(Mobile m, string[] lines)
			: base(TimeSpan.FromSeconds(7.5), TimeSpan.FromSeconds(12.5))
		{
			m_Mobile = m;
			m_Lines = lines;
		}
