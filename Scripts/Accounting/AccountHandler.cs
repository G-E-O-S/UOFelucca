...
namespace Server.Misc
{
    ...
    public class AccountHandler
    {
        ...
        private static readonly int MaxAccountsPerIP = Config.Get("Accounts.AccountsPerIp", 4);
        ...
        new CityInfo( "Ocllo",      "Bank", 1014161, 3692,  2522,   0, Map.Felucca),
        new CityInfo( "Yew",        "Bank", 1075072, 659,   815,    0, Map.Felucca),
        new CityInfo( "Minoc",      "Bank", 1075073, 2504,  562,    0, Map.Felucca),
        new CityInfo( "Britain",    "Bank", 1075074, 1434,  1679,   10, Map.Felucca),
        new CityInfo( "Moonglow",   "Bank", 1075075, 4463,  1170,   0,  Map.Felucca),
        new CityInfo( "Trinsic",    "Bank", 1075076, 1821,  2822,   0,  Map.Felucca),
        new CityInfo( "Jhelom",     "Bank", 1075078, 1321,  3777,   0,  Map.Felucca),
        new CityInfo( "Skara Brae", "Bank", 1075079, 596,   2138,   0,  Map.Felucca),
        new CityInfo( "Vesper",     "Bank", 1075080, 2889,  681,    0,  Map.Felucca)
        };
        ...
        */
        ...
        private static readonly bool PasswordCommandEnabled = Config.Get("Accounts.PasswordCommandEnabled", true);
