...
namespace Server.Items
{
    ...
    public class HousePlacementEntry
    {
        ...
        {
            new HousePlacementEntry(typeof(SmallOldHouse),      1011303,	425,	212,	489,	244,	10,	32500, 0,	4,	0,	0x0064),
            new HousePlacementEntry(typeof(SmallOldHouse),      1011304,	425,	212,	489,	244,	10,	32500, 0,	4,	0,	0x0066),
            new HousePlacementEntry(typeof(SmallOldHouse),      1011305,	425,	212,	489,	244,	10,	35000, 0,	4,	0,	0x0068),
            new HousePlacementEntry(typeof(SmallOldHouse),      1011306,	425,	212,	489,	244,	10,	37500, 0,	4,	0,	0x006A),
            new HousePlacementEntry(typeof(SmallOldHouse),      1011307,	425,	212,	489,	244,	10,	40000, 0,	4,	0,	0x006C),
            new HousePlacementEntry(typeof(SmallOldHouse),      1011308,	425,	212,	489,	244,	10,	50000, 0,	4,	0,	0x006E),
            new HousePlacementEntry(typeof(SmallShop),          1011321,	425,	212,	489,	244,	10,	60000, -1,	4,	0,	0x00A0),
            new HousePlacementEntry(typeof(SmallShop),          1011322,	425,	212,	489,	244,	10,	75000, 0,	4,	0,	0x00A2),
            new HousePlacementEntry(typeof(SmallTower),         1011317,	580,	290,	667,	333,	14,	100000, 3,	4,	0,	0x0098),
            new HousePlacementEntry(typeof(TwoStoryVilla),      1011319,	1100,	550,	1265,	632,	24,	125000, 3,	6,	0,	0x009E),
            new HousePlacementEntry(typeof(SandStonePatio),     1011320,	850,	425,	1265,	632,	24,	150000, -1,	4,	0,	0x009C),
            new HousePlacementEntry(typeof(LogCabin),           1011318,	1100,	550,	1265,	632,	24,	175000, 1,	6,	0,	0x009A),
            new HousePlacementEntry(typeof(GuildHouse),         1011309,	1370,	685,	1576,	788,	28,	275000, -1,	7,	0,	0x0074),
            new HousePlacementEntry(typeof(TwoStoryHouse),      1011310,	1370,	685,	1576,	788,	28,	350000, -3,	7,	0,	0x0076),
            new HousePlacementEntry(typeof(TwoStoryHouse),      1011311,	1370,	685,	1576,	788,	28,	350000, -3,	7,	0,	0x0078),
            new HousePlacementEntry(typeof(LargePatioHouse),    1011315,	1370,	685,	1576,	788,	28,	375000, -4,	7,	0,	0x008C),
            new HousePlacementEntry(typeof(LargeMarbleHouse),   1011316,	1370,	685,	1576,	788,	28,	400000, -4,	7,	0,	0x0096),
            new HousePlacementEntry(typeof(Tower),              1011312,	2119,	1059,	2437,	1218,	42,	750000, 0,	7,	0,	0x007A),
            new HousePlacementEntry(typeof(Keep),               1011313,	2625,	1312,	3019,	1509,	52,	1800000, 0, 11,	0,	0x007C),
            new HousePlacementEntry(typeof(Castle),             1011314,	4076,	2038,	4688,	2344,	78,	5000000, 0, 16,	0,	0x007E),
        };
        ...
        {
            new HousePlacementEntry(typeof(HouseFoundation),            1158538,	2625,	1312,	3019,	1509,	78,	2500000, 0,	10,	0,	0x147C), // 23x23 3-Story Customizable Keep
            new HousePlacementEntry(typeof(HouseFoundation),            1158539,	4076,	2038,	4688,	2344,	78,	8500000, 0,	10,	0,	0x147D),  // 32x32 3-Story Customizable Castle

            new HousePlacementEntry(typeof(VillaCrowley),               1158852,    2625,   1312,   3019,   1509,   52, 10000000, 0, 11,    0,  0x1486),
            new HousePlacementEntry(typeof(SandalwoodKeep),             1158854,    2625,   1312,   3019,   1509,   52, 10000000, 0, 11,    0,  0x1488),
            new HousePlacementEntry(typeof(RobinsNest),                 1158850,    2625,   1312,   3019,   1509,   52, 10000000, 0, 11,    0,  0x1484),
            new HousePlacementEntry(typeof(CasaMoga),                   1158855,    2625,   1312,   3019,   1509,   52, 10000000, 0, 11,    0,  0x1489),
            new HousePlacementEntry(typeof(TraditionalKeep),            1158851,    2625,   1312,   3019,   1509,   52, 10000000, 0, 11,    0,  0x1485),            
            new HousePlacementEntry(typeof(DarkthornKeep),              1158853,    2625,   1312,   3019,   1509,   52, 10000000, 0, 11,    0,  0x1487),
            new HousePlacementEntry(typeof(TrinsicKeep),                1158748,    2625,   1312,   3019,   1509,   52, 10000000, 0, 11,    0,  0x147E),
            new HousePlacementEntry(typeof(FeudalCastle),               1158762,    4076,   2038,   4688,   2344,   78, 20000000, 0, 16,    0,  0x1483),
            new HousePlacementEntry(typeof(OkinawaSweetDreamCastle),    1158963,    4076,   2038,   4688,   2344,   78, 20000000, 0, 16,    0,  0x148D),
            new HousePlacementEntry(typeof(GrimswindSisters),           1158965,    4076,   2038,   4688,   2344,   78, 20000000, 0, 16,    0,  0x148F),
            new HousePlacementEntry(typeof(RobinsRoost),                1158960,    4076,   2038,   4688,   2344,   78, 20000000, 0, 16,    0,  0x148A),
            new HousePlacementEntry(typeof(GothicRoseCastle),           1158749,    4076,   2038,   4688,   2344,   78, 20000000, 0, 16,    0,  0x147F),
            new HousePlacementEntry(typeof(LacrimaeInCaelo),            1158962,    4076,   2038,   4688,   2344,   78, 20000000, 0, 16,    0,  0x148C),
            new HousePlacementEntry(typeof(ElsaCastle),                 1158750,    4076,   2038,   4688,   2344,   78, 20000000, 0, 16,    0,  0x1480),
            new HousePlacementEntry(typeof(Spires),                     1158761,    4076,   2038,   4688,   2344,   78, 20000000, 0, 16,    0,  0x1481),
            new HousePlacementEntry(typeof(Camelot),                    1158961,    4076,   2038,   4688,   2344,   78, 20000000, 0, 16,    0,  0x148B),
            new HousePlacementEntry(typeof(TheSandstoneCastle),         1158964,    4076,   2038,   4688,   2344,   78, 20000000, 0, 16,    0,  0x148E),
            new HousePlacementEntry(typeof(CastleOfOceania),            1158760,    4076,   2038,   4688,   2344,   78, 20000000, 0, 16,    0,  0x1482),
        };
        ...
        private static readonly HousePlacementEntry[] m_ThreeStoryFoundations = new HousePlacementEntry[]
        {
            ...
            new HousePlacementEntry(typeof(HouseFoundation), 1060353,	1350,	675,	1553,	776,	28,	115000, 0,	6,	0,	0x145C), // 16x11 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060354,	1370,	685,	1576,	788,	28,	125000, 0,	7,	0,	0x145D), // 16x12 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060355,	1370,	685,	1576,	788,	28,	150000, 0,	7,	0,	0x145E), // 16x13 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060356,	2119,	1059,	2437,	1218,	42,	200000, 0,	8,	0,	0x145F), // 16x14 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060357,	2119,	1059,	2437,	1218,	42,	300000, 0,	8,	0,	0x1460), // 16x15 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060358,	2119,	1059,	2437,	1218,	42,	400000, 0,	9,	0,	0x1461), // 16x16 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060359,	2119,	1059,	2437,	1218,	42,	500000, 0,	9,	0,	0x1462), // 16x17 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060360,	2119,	1059,	2437,	1218,	42,	600000, 0,	10,	0,	0x1463), // 16x18 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060366,	1370,	685,	1576,	788,	28,	625000, 0,	7,	0,	0x1469), // 17x12 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060367,	2119,	1059,	2437,	1218,	42,	650000, 0,	7,	0,	0x146A), // 17x13 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060368,	2119,	1059,	2437,	1218,	42,	675000, 0,	8,	0,	0x146B), // 17x14 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060369,	2119,	1059,	2437,	1218,	42,	700000, 0,	8,	0,	0x146C), // 17x15 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060370,	2119,	1059,	2437,	1218,	42,	725000, 0,	9,	0,	0x146D), // 17x16 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060371,	2119,	1059,	2437,	1218,	42,	750000, 0,	9,	0,	0x146E), // 17x17 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060372,	2119,	1059,	2437,	1218,	42,	775000, 0,	10,	0,	0x146F), // 17x18 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060379,	2119,	1059,	2437,	1218,	42,	715000, 0,	7,	0,	0x1476), // 18x13 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060380,	2119,	1059,	2437,	1218,	42,	725000, 0,	8,	0,	0x1477), // 18x14 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060381,	2119,	1059,	2437,	1218,	42,	750000, 0,	8,	0,	0x1478), // 18x15 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060382,	2119,	1059,	2437,	1218,	42,	770000, 0,	9,	0,	0x1479), // 18x16 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060383,	2119,	1059,	2437,	1218,	42,	790000, 0,	9,	0,	0x147A), // 18x17 3-Story Customizable House
            new HousePlacementEntry(typeof(HouseFoundation), 1060384,	2119,	1059,	2437,	1218,	42,	800000, 0,	10,	0,	0x147B) // 18x18 3-Story Customizable House
        };
