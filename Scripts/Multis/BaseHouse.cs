...
namespace Server.Multis
{
    public abstract class BaseHouse : BaseMulti
    {
        ...
        public static bool NewVendorSystem { get { return Core.LBR; } } // Is new player vendor system enabled?

        public static double GlobalBonusStorageScalar { get { return Core.ML ? Core.SA ? 8.4 : 7.2 : 6.0; } } // changed from 1.4 : 1.2 : 1.0; - 4.2 : 3.6 : 3.0
        ...
        public virtual TimeSpan DecayPeriod { get { return TimeSpan.FromDays(21.0); } }
        ...
        public virtual TimeSpan RestrictedPlacingTime { get { return TimeSpan.FromHours(0.1); } }
        ...
        public virtual bool IsAosRules { get { return Core.LBR; } }
        ...
        public void AddTrashBarrel(Mobile from)
        {
            ...
            {
                m_Trash.Delete();// from.SendLocalizedMessage(502117); // You already have a trash barrel!
            }
        }
