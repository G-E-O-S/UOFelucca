...
namespace Server.Multis
{
    public class DynamicDecay
    {
        ...
        static DynamicDecay()
        {
            ...
            Register(DecayLevel.Slightly, TimeSpan.FromDays(4), TimeSpan.FromDays(5));
            Register(DecayLevel.Somewhat, TimeSpan.FromDays(4), TimeSpan.FromDays(5));
            Register(DecayLevel.Fairly, TimeSpan.FromDays(4), TimeSpan.FromDays(5));
            Register(DecayLevel.Greatly, TimeSpan.FromDays(3), TimeSpan.FromDays(4));
