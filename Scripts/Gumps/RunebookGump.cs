...
namespace Server.Gumps
{
    public class RunebookGump : Gump
    {
        ...
        private class InternalPrompt : Prompt
        {
            ...
            {
                if (m_Book.Deleted || !from.InRange(m_Book.GetWorldLocation(), (Core.ML ? 3 : 2)))
                    return;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            if (Book.Deleted || !from.InRange(Book.GetWorldLocation(), (Core.ML ? 3 : 2)) || !Multis.DesignContext.Check(from))
            {
