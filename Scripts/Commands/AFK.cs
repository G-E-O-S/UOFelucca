...
namespace Felladrin.Commands
{
    public static class AFK
    {
        ...
        public static void Initialize()
        {
            if (Config.Enabled)
            {
                CommandSystem.Register("AFK", AccessLevel.Counselor, new CommandEventHandler(OnCommand));
        ...
        class AfkInfo
        {
            public string Message = "Away From Keyboard";
        ...
        static void AnnounceAFK(PlayerMobile pm)
        {
            ...
            Timer.DelayCall(TimeSpan.FromSeconds(30), delegate { AnnounceAFK(pm); });
        }
