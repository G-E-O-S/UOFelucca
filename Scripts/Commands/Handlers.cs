...
namespace Server.Commands
{
    public class CommandHandlers
    {
        public static void Initialize()
        {
            ...
            Register("Where", AccessLevel.Player, new CommandEventHandler(Where_OnCommand)); // default counselor
            ...
            Register("MagicReflect", AccessLevel.Player, new CommandEventHandler(MagicReflect_OnCommand));
        }
        ...
        [Usage("MagicReflect")]
        [Description("Show current magic reflect damage absorb value for player.")]
        public static void MagicReflect_OnCommand(CommandEventArgs e)
        {
            Mobile m = e.Mobile;

            m.SendMessage("Current Magic Reflect Damage Absorb:  " + m.MagicDamageAbsorb);
        }
