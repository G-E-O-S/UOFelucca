            ...
            else if (SpellHelper.CheckTown(p, Caster) && (item != null || CheckSequence()))
            {
                ...
                foreach (var id in targets)
                {
                    ...
                    if (SpellHelper.CheckReflect((int)Circle, ref source, ref target, SpellDamageType))
                    {
                        ...
                        {
                            source.MovingParticles(target, item != null ? 0xA1ED : 0x36D4, 7, 0, false, true, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 9501, 1, 0, 0x100);
                        });
                    }
                    ...
                    Caster.MovingParticles(id, item != null ? 0xA1ED : 0x36D4, 7, 0, false, true, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 9501, 1, 0, 0x100);
                }
