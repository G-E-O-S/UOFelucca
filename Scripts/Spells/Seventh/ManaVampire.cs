    ...
    public class ManaVampireSpell : MagerySpell
    {
        ...
        public void Target(Mobile m)
        {
            ...
            else if (this.CheckHSequence(m))
            {
                ...
                if (Core.AOS)
                {
                    m.FixedParticles(0x374A, 1, 15, 5054, Caster.SpellHue != 0 ? Caster.SpellHue : 23, 7, EffectLayer.Head);
                    m.PlaySound(0x1F9);
                ...
                {
                    m.FixedParticles(0x0000, 10, 5, 2054, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, EffectLayer.Head);
                    m.PlaySound(0x1F9);
                }
