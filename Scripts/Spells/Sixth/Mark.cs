...
namespace Server.Spells.Sixth
{
    public class MarkSpell : MagerySpell
    {
        ...
        public void Target(RecallRune rune)
        {
            ...
            else if (boat == null && SpellHelper.CheckMulti(Caster.Location, Caster.Map, !Core.LBR))
            {
            ...
            {
                //if (!Caster.Region.IsPartOf<Regions.HouseRegion>())
                //{
                //    rune.Mark(Caster);
                ...
                //}
                //else if (Caster.Region.IsPartOf<Regions.HouseRegion>() && Caster.Z == 0)
                {
                    rune.Mark(Caster);
                ...
                //else if (Caster.Region.IsPartOf<Regions.HouseRegion>() && Caster.Z != 0)
                //{
                //    Caster.SendLocalizedMessage(501800);
