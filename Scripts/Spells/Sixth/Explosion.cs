        ...
        private class InternalTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                if (m_Attacker.HarmfulCheck(m_Target))
                {
                    ...
                    if (defender != null)
                    {
                        defender.FixedParticles(0x36BD, 20, 10, 5044, m_Spell.Caster.SpellHue != 0 ? m_Spell.Caster.SpellHue : 0, 0, EffectLayer.Head);
                        defender.PlaySound(0x307);
                    }
                    else
                    {
                        Effects.SendLocationParticles(m_Target, 0x36BD, 20, 10, m_Spell.Caster.SpellHue != 0 ? m_Spell.Caster.SpellHue : 0, 0, 5044, 0);
