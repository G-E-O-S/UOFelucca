        ...
        public void Target(IDamageable m)
        {
            ...
            else if (CheckHSequence(m))
            {
                ...
                if (SpellHelper.CheckReflect((int)Circle, ref source, ref target))
                {
                    ...
                    {
                        source.MovingParticles(target, 0x379F, 7, 0, false, true, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 3043, 4043, 0x211, 0);
                ...
                // Do the effects
                Caster.MovingParticles(m, 0x379F, 7, 0, false, true, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 3043, 4043, 0x211, 0);
