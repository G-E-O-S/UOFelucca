    ...
    public class InvisibilitySpell : MagerySpell
    {
        ...
        public void Target(Mobile m)
        {
            ...
            else if (this.CheckBSequence(m))
            {
                ...
                Effects.SendLocationParticles(EffectItem.Create(new Point3D(m.X, m.Y, m.Z + 16), Caster.Map, EffectItem.DefaultDuration), 0x376A, 10, 15, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 5045, 0);
                m.PlaySound(0x3C4);
