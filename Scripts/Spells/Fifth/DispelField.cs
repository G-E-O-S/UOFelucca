    ...
    public class DispelFieldSpell : MagerySpell
    {
        ...
        public void Target(Item item)
        {
            ...
            else if (this.CheckSequence())
            {
                ...
                Effects.SendLocationParticles(EffectItem.Create(item.Location, item.Map, EffectItem.DefaultDuration), 0x376A, 9, 20, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 5042, 0);
