        ...
        public void Target(IDamageable d)
        {
            ...
            else if (CheckHSequence(d))
            {
                ...
                if (SpellHelper.CheckReflect((int)Circle, ref source, ref target))
                {
                    ...
                    {
                        source.MovingParticles(target, 0x36E4, 5, 0, false, true, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 3043, 4043, 0x211, 0);
                ...
                if (damage > 0)
                {
                    Caster.MovingParticles(d, 0x36E4, 5, 0, false, false, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 3006, 0, 0, 0);
