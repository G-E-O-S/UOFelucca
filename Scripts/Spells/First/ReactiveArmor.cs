        ...
        public override void OnCast()
        {
            ...
            else
            {
                ...
                else if (this.CheckSequence())
                {
                    ...
                    {
                        int value = (int)(this.Caster.Skills[SkillName.Magery].Value + this.Caster.Skills[SkillName.EvalInt].Value + this.Caster.Skills[SkillName.Inscribe].Value);
                        value /= 10; // default 3

                        if (value < 0)
                            value = 1;
                        else if (value > 3) // default 75
                            value = 3; // default 75
