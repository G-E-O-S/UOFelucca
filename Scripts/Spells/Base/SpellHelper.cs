...
namespace Server.Spells
{
    ...
    public class SpellHelper
    {
        ...
        public static int GetSpellDamageBonus(Mobile caster, IDamageable damageable, SkillName skill, bool playerVsPlayer)
        {
            ...
            if (target != null)
            {
                if (RuinedSashOfWarding.IsUnderEffects(target, WardingEffect.SpellDamage))
                    sdiBonus -= 10;
        ...
        private static readonly TimeSpan AosDamageDelay = TimeSpan.FromSeconds(0.2);
        private static readonly TimeSpan OldDamageDelay = TimeSpan.FromSeconds(0.1);
        ...
        public static bool ValidIndirectTarget(Mobile from, Mobile to)
        {
            ...
            //return (Notoriety.Compute(from, to) != Notoriety.Innocent || from.Murderer); //This won't let indirect Damage hit blues players.
            return true;
        }
        ...
        public static IEnumerable<IDamageable> AcquireIndirectTargets(IPoint3D p, Map map, int range)
        {
            if (map == null)
            {
                yield break;
...
/* Recall From */	{ true,     false,      false,      false,      false,      true,           false,          false,      false,              false,              false,              true,       true,       false,          false,                      false,          false,              false,      false,      false,          true,           false,          false,          false },
/* Recall To */		{ true,     false,      false,      false,      false,      true,           false,          false,      false,              false,              false,              false,      false,      false,          false,                      false,          false,              false,      false,      false,          false,          false,          false,          false },
/* Gate From */		{ true,     false,      false,      false,      false,      true,           false,          false,      false,              false,              false,              false,      false,      false,          false,                      false,          false,              false,      false,      false,          false,          false,          false,          false },
/* Gate To */		{ true,     false,      false,      false,      false,      true,           false,          false,      false,              false,              false,              false,      false,      false,          false,                      false,          false,              false,      false,      false,          false,          false,          false,          false },
/* Mark In */		{ true,     false,      false,      false,      false,      true,           false,          false,      false,              false,              false,              false,      false,      false,          false,                      false,          false,              false,      false,      false,          false,          false,          false,          false },
...
/* Tele To */		{ true,     true,       true,       true,       true,       true,           true,           true,       false,              true,               false,              false,      false,      true,           true,                       true,           true,               false,      false,      true,           false,          false,          false,          true },
        ...
        {
            if (map == Map.Felucca) // Check if the map is Felucca
            {                
            ...
            // Block use all gates, recalls, mark in Trammel map
            if (caster is PlayerMobile && (type != TravelCheckType.TeleportTo || type != TravelCheckType.TeleportFrom))
            {                
                caster.SendMessage("Thy spell doth not appear to work...");
                return false;         
            }
