...
namespace Server.Spells
{
    public abstract class Spell : ISpell
    {
        ...
        private static readonly TimeSpan NextSpellDelay = TimeSpan.FromSeconds(0.25); // changed from 0.75
        private static TimeSpan AnimateDelay = TimeSpan.FromSeconds(1.25); // changed from 1.5
        ...
        public virtual bool DelayedDamage { get { return false; } } // maybe changed from ture?
        ...
        public virtual bool DelayedDamageStacking { get { return false; } } // changed from true
        ...
        public virtual bool CheckMovement(Mobile caster)
        {
            if (IsCasting && BlocksMovement && (!(m_Caster is BaseCreature) || ((BaseCreature)m_Caster).FreezeOnCast))
            {
                return true; // false = player is frozen while casting
            }
