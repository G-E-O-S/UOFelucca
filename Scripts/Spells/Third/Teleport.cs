    ...
    public class TeleportSpell : MagerySpell
    {
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (this.CheckSequence())
            {
                ...
                if (m.Player)
                {
                    Effects.SendLocationParticles(EffectItem.Create(from, m.Map, EffectItem.DefaultDuration), 0x3728, 10, 10, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 2023, 0);
                    Effects.SendLocationParticles(EffectItem.Create(to, m.Map, EffectItem.DefaultDuration), 0x3728, 10, 10, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 5023, 0);
                }
                else
                {
                    m.FixedParticles(0x376A, 9, 32, 0x13AF, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, EffectLayer.Waist);
                }
