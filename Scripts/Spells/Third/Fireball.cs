            ...
            else if (CheckHSequence(m))
            {
                ...
                if (SpellHelper.CheckReflect((int)Circle, ref source, ref target))
                {
                    Timer.DelayCall(TimeSpan.FromSeconds(.5), () =>
                        {
                            source.MovingParticles(target, 0x36D4, 7, 0, false, true, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 9502, 4019, 0x160, 0);
                ...
                if (damage > 0)
                {
                    Caster.MovingParticles(m, 0x36D4, 7, 0, false, true, Caster.SpellHue != 0 ? Caster.SpellHue : 0, 0, 9502, 4019, 0x160, 0);
