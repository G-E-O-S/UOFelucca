        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object o)
            {
                ...
                if (this.m_Owner.CheckSequence())
                {
                    ...
                    Effects.SendLocationParticles(EffectItem.Create(new Point3D(loc), from.Map, EffectItem.DefaultDuration), 0x376A, 9, 32, from.SpellHue != 0 ? from.SpellHue : 0, 0, 5024, 0);
