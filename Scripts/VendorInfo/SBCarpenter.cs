    ...
    public class SBCarpenter : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                Add(new GenericBuyInfo(typeof(FootStool), 28, 20, 0xB5E, 0));
                Add(new GenericBuyInfo(typeof(WoodenBox), 32, 20, 0x9AA, 0));
                Add(new GenericBuyInfo(typeof(SmallCrate), 34, 20, 0x9A9, 0));
                Add(new GenericBuyInfo(typeof(MediumCrate), 40, 20, 0xE3F, 0));
                Add(new GenericBuyInfo(typeof(LargeCrate), 46, 20, 0xE3D, 0));
                Add(new GenericBuyInfo(typeof(LargeTable), 52, 20, 0xB90, 0));
