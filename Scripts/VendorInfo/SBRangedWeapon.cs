    ...
    public class SBRangedWeapon : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                Add(new GenericBuyInfo(typeof(Bolt), 2, 999, 0x1BFB, 0, true)); // default Utility.Random(30, 60)
                Add(new GenericBuyInfo(typeof(Bow), 40, 20, 0x13B2, 0));
                Add(new GenericBuyInfo(typeof(Arrow), 2, 999, 0xF3F, 0, true)); // default Utility.Random(30, 60)
