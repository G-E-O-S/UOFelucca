...
{ 
    public class SBVarietyDealer : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            ...
            {
                Add(new GenericBuyInfo(typeof(Bandage), 5, 999, 0xE21, 0, true));
                ...
                Add(new GenericBuyInfo(typeof(Bolt), 6, 999, 0x1BFB, 0, true)); // default Utility.Random(30, 60)
                Add(new GenericBuyInfo(typeof(Arrow), 3, 999, 0xF3F, 0, true)); // default Utility.Random(30, 60)
